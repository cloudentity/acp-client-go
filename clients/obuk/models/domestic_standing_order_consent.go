...
func (m *DomesticStandingOrderConsent) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 OBWriteDomesticStandingOrderConsentResponse6Data
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.OBWriteDomesticStandingOrderConsentResponse6Data = aO0
...
func (m DomesticStandingOrderConsent) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.OBWriteDomesticStandingOrderConsentResponse6Data)
	if err != nil {
		return nil, err
	}
...
func (m *DomesticStandingOrderConsent) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteDomesticStandingOrderConsentResponse6Data
	if err := m.OBWriteDomesticStandingOrderConsentResponse6Data.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DomesticStandingOrderConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteDomesticStandingOrderConsentResponse6Data
	if err := m.OBWriteDomesticStandingOrderConsentResponse6Data.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with OBRisk1
...
func (m *DomesticStandingOrderConsent) UnmarshalBinary(b []byte) error {
	var res DomesticStandingOrderConsent
