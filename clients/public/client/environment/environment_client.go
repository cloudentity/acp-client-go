...
func (a *Client) GetPublicEnvironment(params *GetPublicEnvironmentParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetPublicEnvironmentOK, error) {
	...
	if params == nil {
		params = NewGetPublicEnvironmentParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getPublicEnvironment",
		Method:             "GET",
		...
		Params:             params,
		Reader:             &GetPublicEnvironmentReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetPublicEnvironmentOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getPublicEnvironment: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
