...
type RevokeTokensParams struct {
	...
	/* RevokeCurrentToken.
	   ...
	   Optional flag to revoke current token
	*/
	RevokeCurrentToken *bool
...
func (o *RevokeTokensParams) SetDefaults() {
	var (
		revokeCurrentTokenDefault = bool(false)
	)

	val := RevokeTokensParams{
		RevokeCurrentToken: &revokeCurrentTokenDefault,
	}
...
// WithRevokeCurrentToken adds the revokeCurrentToken to the revoke tokens params
func (o *RevokeTokensParams) WithRevokeCurrentToken(revokeCurrentToken *bool) *RevokeTokensParams {
	o.SetRevokeCurrentToken(revokeCurrentToken)
	return o
}

// SetRevokeCurrentToken adds the revokeCurrentToken to the revoke tokens params
func (o *RevokeTokensParams) SetRevokeCurrentToken(revokeCurrentToken *bool) {
	o.RevokeCurrentToken = revokeCurrentToken
}
...
func (o *RevokeTokensParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.RevokeCurrentToken != nil {

		// query param revoke_current_token
		var qrRevokeCurrentToken bool

		if o.RevokeCurrentToken != nil {
			qrRevokeCurrentToken = *o.RevokeCurrentToken
		}
		qRevokeCurrentToken := swag.FormatBool(qrRevokeCurrentToken)
		if qRevokeCurrentToken != "" {

			if err := r.SetQueryParam("revoke_current_token", qRevokeCurrentToken); err != nil {
				return err
			}
		}
	}
