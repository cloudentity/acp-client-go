...
// BrazilCustomerDataAccessConsent brazil customer data access consent
//
// swagger:model BrazilCustomerDataAccessConsent
type BrazilCustomerDataAccessConsent struct {
...
// Validate validates this brazil customer data access consent
func (m *BrazilCustomerDataAccessConsent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCustomerDataAccessConsent) validateConsentID(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateCreationDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateDocument(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateExpirationDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validatePermissions(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateStatus(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateStatusUpdateDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateTransactionFromDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) validateTransactionToDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this brazil customer data access consent based on the context it is used
func (m *BrazilCustomerDataAccessConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCustomerDataAccessConsent) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerDataAccessConsent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BrazilCustomerDataAccessConsent) UnmarshalBinary(b []byte) error {
	var res BrazilCustomerDataAccessConsent
