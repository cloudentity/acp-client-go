...
// OBBRCustomerDataAccessConsent o b b r customer data access consent
//
...
// Validate validates this o b b r customer data access consent
func (m *OBBRCustomerDataAccessConsent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OBBRCustomerDataAccessConsent) validateConsentID(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateCreationDateTime(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateDocument(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validatePermissions(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateStatus(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateStatusUpdateDateTime(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateTransactionFromDateTime(formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) validateTransactionToDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this o b b r customer data access consent based on the context it is used
func (m *OBBRCustomerDataAccessConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OBBRCustomerDataAccessConsent) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) contextValidatePermissions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBBRCustomerDataAccessConsent) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OBBRCustomerDataAccessConsent) UnmarshalBinary(b []byte) error {
	var res OBBRCustomerDataAccessConsent
