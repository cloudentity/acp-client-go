...
func (m *GetInternationalPaymentConsentResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GetInternationalPaymentConsentResponse) validateAuthenticationContext(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) validateClientInfo(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) validateInternationalPaymentConsent(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) validateRequestedScopes(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) validateType(formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GetInternationalPaymentConsentResponse) contextValidateRequestedScopes(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GetInternationalPaymentConsentResponse) UnmarshalBinary(b []byte) error {
	var res GetInternationalPaymentConsentResponse
