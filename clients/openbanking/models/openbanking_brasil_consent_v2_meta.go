...
func (m *OpenbankingBrasilConsentV2Meta) validateRequestDateTime(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Meta) validateTotalPages(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Meta) validateTotalRecords(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Meta) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilConsentV2Meta
