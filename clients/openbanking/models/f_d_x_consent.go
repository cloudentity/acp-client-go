...
type FDXConsent struct {
	...
	// Period, in days, for which historical data may be requested; period is measuredfrom request time, not grant time
	LookbackPeriod int64 `json:"lookbackPeriod,omitempty"`

	// a collection of parameters identifying the Parties (including the legal entity operatingbranded products or services)
	// in the data sharing chain. Descriptive information is collectedduring Data Recipient registration at Data Provider,
