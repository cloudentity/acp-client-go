...
// WithWid adds the wid to the revoke openbanking consents params
func (o *RevokeOpenbankingConsentsParams) WithWid(wid string) *RevokeOpenbankingConsentsParams {
	o.SetWid(wid)
	return o
}

// SetWid adds the wid to the revoke openbanking consents params
func (o *RevokeOpenbankingConsentsParams) SetWid(wid string) {
	o.Wid = wid
}
