...
// WithWid adds the wid to the revoke openbanking consent params
func (o *RevokeOpenbankingConsentParams) WithWid(wid string) *RevokeOpenbankingConsentParams {
	o.SetWid(wid)
	return o
}

// SetWid adds the wid to the revoke openbanking consent params
func (o *RevokeOpenbankingConsentParams) SetWid(wid string) {
	o.Wid = wid
}
