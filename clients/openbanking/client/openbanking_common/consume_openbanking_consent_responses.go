...
type ConsumeOpenbankingConsentOK struct {
	Payload *models.OBConsentCommon
}

func (o *ConsumeOpenbankingConsentOK) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentOK  %+v", 200, o.Payload)
}
func (o *ConsumeOpenbankingConsentOK) GetPayload() *models.OBConsentCommon {
	return o.Payload
}
...
func (o *ConsumeOpenbankingConsentOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.OBConsentCommon)
...
func (o *ConsumeOpenbankingConsentBadRequest) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentBadRequest  %+v", 400, o.Payload)
}
...
func (o *ConsumeOpenbankingConsentUnauthorized) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ConsumeOpenbankingConsentForbidden) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentForbidden  %+v", 403, o.Payload)
}
...
func (o *ConsumeOpenbankingConsentNotFound) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentNotFound  %+v", 404, o.Payload)
}
...
func (o *ConsumeOpenbankingConsentTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents/{consentID}/consume][%d] consumeOpenbankingConsentTooManyRequests  %+v", 429, o.Payload)
}
