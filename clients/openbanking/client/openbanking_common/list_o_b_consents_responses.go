...
func (o *ListOBConsentsOK) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsOK  %+v", 200, o.Payload)
}
...
func (o *ListOBConsentsBadRequest) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListOBConsentsUnauthorized) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListOBConsentsForbidden) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListOBConsentsNotFound) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsNotFound  %+v", 404, o.Payload)
}
...
func (o *ListOBConsentsUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ListOBConsentsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /servers/{aid}/open-banking/consents][%d] listOBConsentsTooManyRequests  %+v", 429, o.Payload)
}
