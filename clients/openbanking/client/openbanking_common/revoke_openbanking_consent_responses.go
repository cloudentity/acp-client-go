...
func (o *RevokeOpenbankingConsentNoContent) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentNoContent ", 204)
}
...
func (o *RevokeOpenbankingConsentBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentBadRequest  %+v", 400, o.Payload)
}
...
func (o *RevokeOpenbankingConsentUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RevokeOpenbankingConsentForbidden) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentForbidden  %+v", 403, o.Payload)
}
...
func (o *RevokeOpenbankingConsentNotFound) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentNotFound  %+v", 404, o.Payload)
}
...
func (o *RevokeOpenbankingConsentTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /servers/{aid}/open-banking/consents/{consentID}][%d] revokeOpenbankingConsentTooManyRequests  %+v", 429, o.Payload)
}
