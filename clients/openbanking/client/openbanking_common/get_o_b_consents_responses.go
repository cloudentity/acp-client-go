...
func (o *GetOBConsentsOK) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsOK  %+v", 200, o.Payload)
}
...
func (o *GetOBConsentsBadRequest) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetOBConsentsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetOBConsentsForbidden) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsForbidden  %+v", 403, o.Payload)
}
...
func (o *GetOBConsentsNotFound) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsNotFound  %+v", 404, o.Payload)
}
...
func (o *GetOBConsentsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /servers/{aid}/open-banking/consents][%d] getOBConsentsTooManyRequests  %+v", 429, o.Payload)
}
