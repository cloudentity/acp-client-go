...
func (o *GetConfiguredLicensesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /api/admin/tenants/licenses] getConfiguredLicenses", response, response.Code())
	}
}
...
func (o *GetConfiguredLicensesOK) Error() string {
	return fmt.Sprintf("[GET /api/admin/tenants/licenses][%d] getConfiguredLicensesOK  %+v", 200, o.Payload)
}
...
func (o *GetConfiguredLicensesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/admin/tenants/licenses][%d] getConfiguredLicensesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetConfiguredLicensesForbidden) Error() string {
	return fmt.Sprintf("[GET /api/admin/tenants/licenses][%d] getConfiguredLicensesForbidden  %+v", 403, o.Payload)
}
...
func (o *GetConfiguredLicensesNotFound) Error() string {
	return fmt.Sprintf("[GET /api/admin/tenants/licenses][%d] getConfiguredLicensesNotFound  %+v", 404, o.Payload)
}
...
func (o *GetConfiguredLicensesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/tenants/licenses][%d] getConfiguredLicensesTooManyRequests  %+v", 429, o.Payload)
}
