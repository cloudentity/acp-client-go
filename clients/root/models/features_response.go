...
func (m *FeaturesResponse) validateFeatures(formats strfmt.Registry) error {
...
func (m *FeaturesResponse) contextValidateFeatures(ctx context.Context, formats strfmt.Registry) error {
