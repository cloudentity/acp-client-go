...
func (o *AddUserToGroupBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupBadRequest %s", 400, payload)
}
...
func (o *AddUserToGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupUnauthorized %s", 401, payload)
}
...
func (o *AddUserToGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupForbidden %s", 403, payload)
}
...
func (o *AddUserToGroupNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupNotFound %s", 404, payload)
}
...
func (o *AddUserToGroupConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupConflict %s", 409, payload)
}
...
func (o *AddUserToGroupUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupUnprocessableEntity %s", 422, payload)
}
...
func (o *AddUserToGroupTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] addUserToGroupTooManyRequests %s", 429, payload)
}
