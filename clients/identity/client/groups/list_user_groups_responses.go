...
func (o *ListUserGroupsOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsOK %s", 200, payload)
}
...
func (o *ListUserGroupsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsBadRequest %s", 400, payload)
}
...
func (o *ListUserGroupsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsUnauthorized %s", 401, payload)
}
...
func (o *ListUserGroupsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsForbidden %s", 403, payload)
}
...
func (o *ListUserGroupsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsNotFound %s", 404, payload)
}
...
func (o *ListUserGroupsUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsUnprocessableEntity %s", 422, payload)
}
...
func (o *ListUserGroupsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups][%d] listUserGroupsTooManyRequests %s", 429, payload)
}
