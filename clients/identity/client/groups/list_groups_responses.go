...
func (o *ListGroupsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /admin/pools/{ipID}/groups] listGroups", response, response.Code())
	}
}
...
func (o *ListGroupsOK) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsOK  %+v", 200, o.Payload)
}
...
func (o *ListGroupsBadRequest) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListGroupsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListGroupsForbidden) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListGroupsNotFound) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsNotFound  %+v", 404, o.Payload)
}
...
func (o *ListGroupsUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ListGroupsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsTooManyRequests  %+v", 429, o.Payload)
}
