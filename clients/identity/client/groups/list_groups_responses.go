...
func (o *ListGroupsOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsOK %s", 200, payload)
}
...
func (o *ListGroupsBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsBadRequest %s", 400, payload)
}
...
func (o *ListGroupsUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsUnauthorized %s", 401, payload)
}
...
func (o *ListGroupsForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsForbidden %s", 403, payload)
}
...
func (o *ListGroupsNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsNotFound %s", 404, payload)
}
...
func (o *ListGroupsUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsUnprocessableEntity %s", 422, payload)
}
...
func (o *ListGroupsTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups][%d] listGroupsTooManyRequests %s", 429, payload)
}
