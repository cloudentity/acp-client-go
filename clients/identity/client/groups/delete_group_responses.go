...
func (o *DeleteGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /admin/pools/{ipID}/groups/{groupID}] deleteGroup", response, response.Code())
	}
}
...
func (o *DeleteGroupNoContent) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}][%d] deleteGroupNoContent ", 204)
}
...
func (o *DeleteGroupUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}][%d] deleteGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteGroupForbidden) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}][%d] deleteGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteGroupNotFound) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}][%d] deleteGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}][%d] deleteGroupTooManyRequests  %+v", 429, o.Payload)
}
