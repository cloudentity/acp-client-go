...
func (o *IsUserInGroupUnauthorized) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups/{groupID}][%d] isUserInGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *IsUserInGroupForbidden) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups/{groupID}][%d] isUserInGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *IsUserInGroupNotFound) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups/{groupID}][%d] isUserInGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *IsUserInGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/users/{userID}/groups/{groupID}][%d] isUserInGroupTooManyRequests  %+v", 429, o.Payload)
}
