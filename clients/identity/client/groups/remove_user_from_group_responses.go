...
func (o *RemoveUserFromGroupBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupBadRequest  %+v", 400, o.Payload)
}
...
func (o *RemoveUserFromGroupUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RemoveUserFromGroupForbidden) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *RemoveUserFromGroupNotFound) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *RemoveUserFromGroupConflict) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupConflict  %+v", 409, o.Payload)
}
...
func (o *RemoveUserFromGroupUnprocessableEntity) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *RemoveUserFromGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /admin/pools/{ipID}/groups/{groupID}/users/{userID}][%d] removeUserFromGroupTooManyRequests  %+v", 429, o.Payload)
}
