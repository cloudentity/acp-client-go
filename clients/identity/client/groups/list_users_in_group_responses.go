...
func (o *ListUsersInGroupOK) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupOK  %+v", 200, o.Payload)
}
...
func (o *ListUsersInGroupBadRequest) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListUsersInGroupUnauthorized) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListUsersInGroupForbidden) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *ListUsersInGroupNotFound) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *ListUsersInGroupUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ListUsersInGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}/users][%d] listUsersInGroupTooManyRequests  %+v", 429, o.Payload)
}
