...
func (o *GetGroupOK) Error() string {
	...
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}][%d] getGroupOK %s", 200, payload)
}
...
func (o *GetGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}][%d] getGroupUnauthorized %s", 401, payload)
}
...
func (o *GetGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}][%d] getGroupForbidden %s", 403, payload)
}
...
func (o *GetGroupNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}][%d] getGroupNotFound %s", 404, payload)
}
...
func (o *GetGroupTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[GET /admin/pools/{ipID}/groups/{groupID}][%d] getGroupTooManyRequests %s", 429, payload)
}
