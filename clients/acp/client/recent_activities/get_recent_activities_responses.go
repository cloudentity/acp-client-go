...
func (o *GetRecentActivitiesOK) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/recent-activities][%d] getRecentActivitiesOK  %+v", 200, o.Payload)
}
...
func (o *GetRecentActivitiesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/recent-activities][%d] getRecentActivitiesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetRecentActivitiesForbidden) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/recent-activities][%d] getRecentActivitiesForbidden  %+v", 403, o.Payload)
}
...
func (o *GetRecentActivitiesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/recent-activities][%d] getRecentActivitiesTooManyRequests  %+v", 429, o.Payload)
}
