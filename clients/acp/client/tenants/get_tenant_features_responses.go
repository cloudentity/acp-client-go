...
GetTenantFeaturesResponse
*/
type GetTenantFeaturesOK struct {
	Payload *models.GetTenantFeaturesResponse
}
...
func (o *GetTenantFeaturesOK) GetPayload() *models.GetTenantFeaturesResponse {
	return o.Payload
}
...
func (o *GetTenantFeaturesOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GetTenantFeaturesResponse)
