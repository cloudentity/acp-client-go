...
func (o *PatchTenantConfigurationParams) SetDefaults() {
	...
	val := PatchTenantConfigurationParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the patch tenant configuration params
func (o *PatchTenantConfigurationParams) WithTid(tid string) *PatchTenantConfigurationParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the patch tenant configuration params
func (o *PatchTenantConfigurationParams) SetTid(tid string) {
	o.Tid = tid
}
