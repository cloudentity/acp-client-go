...
func (o *DeleteMFAMethodNoContent) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/mfa-methods/{mfaID}][%d] deleteMFAMethodNoContent ", 204)
}
...
func (o *DeleteMFAMethodUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/mfa-methods/{mfaID}][%d] deleteMFAMethodUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteMFAMethodForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/mfa-methods/{mfaID}][%d] deleteMFAMethodForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteMFAMethodNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/mfa-methods/{mfaID}][%d] deleteMFAMethodNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteMFAMethodTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/mfa-methods/{mfaID}][%d] deleteMFAMethodTooManyRequests  %+v", 429, o.Payload)
}
