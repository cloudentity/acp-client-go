...
func (o *RotateClientSecretAsDeveloperOK) Error() string {
	return fmt.Sprintf("[POST /api/developer/{tid}/{aid}/clients/{cid}/rotateSecret][%d] rotateClientSecretAsDeveloperOK  %+v", 200, o.Payload)
}
...
func (o *RotateClientSecretAsDeveloperUnauthorized) Error() string {
	return fmt.Sprintf("[POST /api/developer/{tid}/{aid}/clients/{cid}/rotateSecret][%d] rotateClientSecretAsDeveloperUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RotateClientSecretAsDeveloperForbidden) Error() string {
	return fmt.Sprintf("[POST /api/developer/{tid}/{aid}/clients/{cid}/rotateSecret][%d] rotateClientSecretAsDeveloperForbidden  %+v", 403, o.Payload)
}
...
func (o *RotateClientSecretAsDeveloperNotFound) Error() string {
	return fmt.Sprintf("[POST /api/developer/{tid}/{aid}/clients/{cid}/rotateSecret][%d] rotateClientSecretAsDeveloperNotFound  %+v", 404, o.Payload)
}
...
func (o *RotateClientSecretAsDeveloperTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/developer/{tid}/{aid}/clients/{cid}/rotateSecret][%d] rotateClientSecretAsDeveloperTooManyRequests  %+v", 429, o.Payload)
}
