...
func (o *UnbindSystemAPINoContent) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/system/apis/unbind][%d] unbindSystemApiNoContent ", 204)
}
...
func (o *UnbindSystemAPIUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/system/apis/unbind][%d] unbindSystemApiUnauthorized  %+v", 401, o.Payload)
}
...
func (o *UnbindSystemAPIForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/system/apis/unbind][%d] unbindSystemApiForbidden  %+v", 403, o.Payload)
}
...
func (o *UnbindSystemAPITooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/system/apis/unbind][%d] unbindSystemApiTooManyRequests  %+v", 429, o.Payload)
}
