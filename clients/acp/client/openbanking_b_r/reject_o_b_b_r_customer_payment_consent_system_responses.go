...
func (o *RejectOBBRCustomerPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking-brasil/payment/{login}/reject][%d] rejectOBBRCustomerPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
