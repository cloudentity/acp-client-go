...
func (o *ObbrPaymentConsentIntrospectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/introspect][%d] obbrPaymentConsentIntrospectTooManyRequests  %+v", 429, o.Payload)
}
