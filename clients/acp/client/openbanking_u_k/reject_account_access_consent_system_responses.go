...
func (o *RejectAccountAccessConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/account-access-consent/{login}/reject][%d] rejectAccountAccessConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
