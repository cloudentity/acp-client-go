...
func (o *OpenbankingFilePaymentConsentIntrospectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/introspect][%d] openbankingFilePaymentConsentIntrospectTooManyRequests  %+v", 429, o.Payload)
}
