...
func (o *SetCIBAAuthenticationServiceOK) Error() string {
	return fmt.Sprintf("[PUT /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] setCIBAAuthenticationServiceOK  %+v", 200, o.Payload)
}
...
func (o *SetCIBAAuthenticationServiceUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] setCIBAAuthenticationServiceUnauthorized  %+v", 401, o.Payload)
}
...
func (o *SetCIBAAuthenticationServiceForbidden) Error() string {
	return fmt.Sprintf("[PUT /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] setCIBAAuthenticationServiceForbidden  %+v", 403, o.Payload)
}
...
func (o *SetCIBAAuthenticationServiceNotFound) Error() string {
	return fmt.Sprintf("[PUT /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] setCIBAAuthenticationServiceNotFound  %+v", 404, o.Payload)
}
...
func (o *SetCIBAAuthenticationServiceTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] setCIBAAuthenticationServiceTooManyRequests  %+v", 429, o.Payload)
}
