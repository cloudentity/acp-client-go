...
func (o *GetCIBAAuthenticationServiceOK) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] getCIBAAuthenticationServiceOK  %+v", 200, o.Payload)
}
...
func (o *GetCIBAAuthenticationServiceUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] getCIBAAuthenticationServiceUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetCIBAAuthenticationServiceForbidden) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] getCIBAAuthenticationServiceForbidden  %+v", 403, o.Payload)
}
...
func (o *GetCIBAAuthenticationServiceNotFound) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] getCIBAAuthenticationServiceNotFound  %+v", 404, o.Payload)
}
...
func (o *GetCIBAAuthenticationServiceTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/ciba-authentication-service][%d] getCIBAAuthenticationServiceTooManyRequests  %+v", 429, o.Payload)
}
