...
// WithTid adds the tid to the set script execution points params
func (o *SetScriptExecutionPointsParams) WithTid(tid string) *SetScriptExecutionPointsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the set script execution points params
func (o *SetScriptExecutionPointsParams) SetTid(tid string) {
	o.Tid = tid
}
