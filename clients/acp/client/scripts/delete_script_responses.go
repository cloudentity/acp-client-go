...
func (o *DeleteScriptNoContent) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptNoContent ", 204)
}
...
func (o *DeleteScriptBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteScriptUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteScriptForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteScriptNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptNotFound  %+v", 404, o.Payload)
}
...
func (o *DeleteScriptTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /api/admin/{tid}/servers/{aid}/scripts/{script}][%d] deleteScriptTooManyRequests  %+v", 429, o.Payload)
}
