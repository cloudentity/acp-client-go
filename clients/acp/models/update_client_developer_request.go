...
const (
	...
	// UpdateClientDeveloperRequestTokenEndpointAuthSigningAlgH256 captures enum value "H256"
	UpdateClientDeveloperRequestTokenEndpointAuthSigningAlgH256 string = "H256"
)
