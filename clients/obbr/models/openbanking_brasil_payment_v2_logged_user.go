...
func (m *OpenbankingBrasilPaymentV2LoggedUser) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2LoggedUser) validateDocument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2LoggedUser) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2LoggedUser) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2LoggedUser
