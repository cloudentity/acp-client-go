...
func (m *OpenbankingBrasilPaymentV3BusinessEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3BusinessEntity) validateDocument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3BusinessEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3BusinessEntity) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3BusinessEntity) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3BusinessEntity
