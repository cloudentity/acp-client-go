...
func (m *OBBRErrorResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *OBBRErrorResponse) contextValidateErrors(ctx context.Context, formats strfmt.Registry) error {
