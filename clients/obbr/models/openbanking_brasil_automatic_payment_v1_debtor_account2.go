...
// OpenbankingBrasilAutomaticPaymentV1DebtorAccount2 OpenbankingBrasilAutomaticPaymentV1DebtorAccount2 DebtorAccount2
//
...
//
// swagger:model OpenbankingBrasilAutomaticPaymentV1DebtorAccount2
type OpenbankingBrasilAutomaticPaymentV1DebtorAccount2 struct {
...
// Validate validates this openbanking brasil automatic payment v1 debtor account2
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) validateNumber(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil automatic payment v1 debtor account2 based on the context it is used
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount2) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilAutomaticPaymentV1DebtorAccount2
