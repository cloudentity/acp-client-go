...
type OpenbankingBrasilPaymentV2Identification struct {
	...
	// person type
	// Required: true
	PersonType *OpenbankingBrasilPaymentV2EnumPaymentPersonType `json:"personType"`
}

// Validate validates this openbanking brasil payment v2 identification
func (m *OpenbankingBrasilPaymentV2Identification) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2Identification) validateCpfCnpj(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Identification) validateName(formats strfmt.Registry) error {
	...
	if err := validate.Pattern("name", "body", m.Name, `^([A-Za-z---' -]+)$`); err != nil {
		return err
	}
...
func (m *OpenbankingBrasilPaymentV2Identification) validatePersonType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Identification) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2Identification) contextValidatePersonType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Identification) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2Identification
