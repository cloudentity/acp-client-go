...
func (m OpenbankingBrasilPaymentV3EnumPaymentPersonType) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this openbanking brasil payment v3 enum payment person type based on context it is used
func (m OpenbankingBrasilPaymentV3EnumPaymentPersonType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
