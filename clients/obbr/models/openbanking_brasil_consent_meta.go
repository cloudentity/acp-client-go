...
func (m *OpenbankingBrasilConsentMeta) validateRequestDateTime(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentMeta) validateTotalPages(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentMeta) validateTotalRecords(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentMeta) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilConsentMeta
