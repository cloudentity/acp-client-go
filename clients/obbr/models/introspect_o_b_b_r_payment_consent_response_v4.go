...
// IntrospectOBBRPaymentConsentResponseV4 introspect o b b r payment consent response v4
//
// swagger:model IntrospectOBBRPaymentConsentResponseV4
type IntrospectOBBRPaymentConsentResponseV4 struct {
	IntrospectResponse
...
func (m *IntrospectOBBRPaymentConsentResponseV4) UnmarshalJSON(raw []byte) error {
	// AO0
	...
	var dataAO1 struct {
		...
		BusinessEntity *OpenbankingBrasilPaymentV4BusinessEntity `json:"businessEntity,omitempty"`

		ConsentID *string `json:"consentId"`

		CreationDateTime *strfmt.DateTime `json:"creationDateTime"`

		Creditor *OpenbankingBrasilPaymentV4Identification `json:"creditor"`

		DebtorAccount *OpenbankingBrasilPaymentV4ConsentsDebtorAccount `json:"debtorAccount,omitempty"`

		ExpirationDateTime *strfmt.DateTime `json:"expirationDateTime"`

		LoggedUser *OpenbankingBrasilPaymentV4LoggedUser `json:"loggedUser"`

		Payment *OpenbankingBrasilPaymentV4PaymentConsent `json:"payment"`

		RejectionReason *OpenbankingBrasilPaymentV4ConsentRejectionReason `json:"rejectionReason,omitempty"`

		Status *OpenbankingBrasilPaymentV4EnumAuthorisationStatusType `json:"status"`
...
func (m IntrospectOBBRPaymentConsentResponseV4) MarshalJSON() ([]byte, error) {
...
// Validate validates this introspect o b b r payment consent response v4
func (m *IntrospectOBBRPaymentConsentResponseV4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateBusinessEntity(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateConsentID(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateCreationDateTime(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateCreditor(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateDebtorAccount(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateExpirationDateTime(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateLoggedUser(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validatePayment(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateRejectionReason(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateStatus(formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) validateStatusUpdateDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this introspect o b b r payment consent response v4 based on the context it is used
func (m *IntrospectOBBRPaymentConsentResponseV4) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateBusinessEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateCreditor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateDebtorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateLoggedUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidatePayment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateRejectionReason(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *IntrospectOBBRPaymentConsentResponseV4) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *IntrospectOBBRPaymentConsentResponseV4) UnmarshalBinary(b []byte) error {
	var res IntrospectOBBRPaymentConsentResponseV4
