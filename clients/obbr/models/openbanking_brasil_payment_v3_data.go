...
type OpenbankingBrasilPaymentV3Data struct {
	...
	// debtor account
	DebtorAccount *OpenbankingBrasilPaymentV3DebtorAccount `json:"debtorAccount,omitempty"`
	...
	// payment
	// Required: true
	Payment *OpenbankingBrasilPaymentV3Payment `json:"payment"`
}
...
func (m *OpenbankingBrasilPaymentV3Data) validateBusinessEntity(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) validateCreditor(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) validateDebtorAccount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) validateLoggedUser(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) validatePayment(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) contextValidateBusinessEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) contextValidateCreditor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) contextValidateDebtorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) contextValidateLoggedUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) contextValidatePayment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Data) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3Data
