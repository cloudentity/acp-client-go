...
func (m *OpenbankingBrasilPaymentV3LinkSingle) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3LinkSingle) validateSelf(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3LinkSingle) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3LinkSingle
