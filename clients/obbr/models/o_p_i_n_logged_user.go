...
func (m *OPINLoggedUser) validateDocument(formats strfmt.Registry) error {
...
func (m *OPINLoggedUser) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
