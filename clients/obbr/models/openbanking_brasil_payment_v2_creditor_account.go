...
type OpenbankingBrasilPaymentV2CreditorAccount struct {
	...
	// account type
	// Required: true
	AccountType *OpenbankingBrasilPaymentV2EnumAccountPaymentsType `json:"accountType"`
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2CreditorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2CreditorAccount
