...
func (m *OpenbankingBrasilConsentDocument1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilConsentDocument1) validateIdentification(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentDocument1) validateRel(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentDocument1) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilConsentDocument1
