...
type OpenbankingBrasilPaymentV2Details struct {
	...
	// creditor account
	// Required: true
	CreditorAccount *OpenbankingBrasilPaymentV2CreditorAccount `json:"creditorAccount"`

	// local instrument
	// Required: true
	LocalInstrument *OpenbankingBrasilPaymentV2EnumLocalInstrument `json:"localInstrument"`
...
func (m *OpenbankingBrasilPaymentV2Details) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2Details) validateCreditorAccount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) validateLocalInstrument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) validateProxy(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) validateQrCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) contextValidateCreditorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) contextValidateLocalInstrument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Details) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2Details
