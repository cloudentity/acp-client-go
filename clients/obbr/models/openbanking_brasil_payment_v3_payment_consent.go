...
type OpenbankingBrasilPaymentV3PaymentConsent struct {
	...
	// details
	// Required: true
	Details *OpenbankingBrasilPaymentV3Details `json:"details"`
	...
	// schedule
	Schedule *OpenbankingBrasilPaymentV3Schedule `json:"schedule,omitempty"`
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateAmount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateCurrency(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateDate(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateDetails(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateIbgeTownCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateSchedule(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) validateType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) contextValidateDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) contextValidateSchedule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3PaymentConsent) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3PaymentConsent
