...
func (m *OpenbankingBrasilPaymentV3Payment) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3Payment) validateAmount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateCurrency(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateDate(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateDetails(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateIbgeTownCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateSchedule(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) validateType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) contextValidateDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) contextValidateSchedule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Payment) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3Payment
