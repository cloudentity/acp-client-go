...
func (o *DeleteDataAccessConsentDeprecatedReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[DELETE /open-banking-brasil/open-banking/consents/v1/consents/{consentID}] DeleteDataAccessConsentDeprecated", response, response.Code())
	}
}
