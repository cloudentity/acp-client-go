...
func (o *PatchWorkspaceConfigRfc6902BadRequest) Error() string {
	...
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902BadRequest %s", 400, payload)
}
...
func (o *PatchWorkspaceConfigRfc6902Unauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902Unauthorized %s", 401, payload)
}
...
func (o *PatchWorkspaceConfigRfc6902Forbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902Forbidden %s", 403, payload)
}
...
func (o *PatchWorkspaceConfigRfc6902NotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902NotFound %s", 404, payload)
}
...
func (o *PatchWorkspaceConfigRfc6902UnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902UnprocessableEntity %s", 422, payload)
}
...
func (o *PatchWorkspaceConfigRfc6902TooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PATCH /{tid}/workspaces/{wid}/promote/config-rfc6902][%d] patchWorkspaceConfigRfc6902TooManyRequests %s", 429, payload)
}
