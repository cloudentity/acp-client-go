...
import (
	...
	"github.com/cloudentity/acp-client-go/clients/hub/client/root_configuration"
...
const (
	...
	// found in Meta (info) section of spec file
	DefaultBasePath string = "/api/hub"
)
...
func New(transport runtime.ClientTransport, formats strfmt.Registry) *Acp {
	...
	cli.RootConfiguration = root_configuration.New(transport, formats)
	cli.TenantConfiguration = tenant_configuration.New(transport, formats)
	cli.WorkspaceConfiguration = workspace_configuration.New(transport, formats)
	return cli
}
...
type Acp struct {
	RootConfiguration root_configuration.ClientService

	TenantConfiguration tenant_configuration.ClientService

	WorkspaceConfiguration workspace_configuration.ClientService
...
func (c *Acp) SetTransport(transport runtime.ClientTransport) {
	...
	c.RootConfiguration.SetTransport(transport)
	c.TenantConfiguration.SetTransport(transport)
	c.WorkspaceConfiguration.SetTransport(transport)
}
