...
// New creates a new tenant configuration API client with basic auth credentials.
...
// New creates a new tenant configuration API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) ExportTenantConfig(params *ExportTenantConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ExportTenantConfigOK, error) {
	...
	if params == nil {
		params = NewExportTenantConfigParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ExportTenantConfig",
		Method:             "GET",
		PathPattern:        "/{tid}/promote/config",
		ProducesMediaTypes: []string{"application/json", "text/csv"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ExportTenantConfigReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*ExportTenantConfigOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ExportTenantConfig: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) ImportTenantConfig(params *ImportTenantConfigParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*ImportTenantConfigNoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewImportTenantConfigParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "ImportTenantConfig",
		Method:             "POST",
		PathPattern:        "/{tid}/promote/config",
		ProducesMediaTypes: []string{"application/json", "text/csv"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &ImportTenantConfigReader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*ImportTenantConfigNoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for ImportTenantConfig: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) PatchTenantConfigRfc6902(params *PatchTenantConfigRfc6902Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchTenantConfigRfc6902NoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPatchTenantConfigRfc6902Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "patchTenantConfigRfc6902",
		Method:             "PATCH",
		PathPattern:        "/{tid}/promote/config-rfc6902",
		ProducesMediaTypes: []string{"application/json", "text/csv"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PatchTenantConfigRfc6902Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PatchTenantConfigRfc6902NoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for patchTenantConfigRfc6902: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
*/
func (a *Client) PatchTenantConfigRfc7396(params *PatchTenantConfigRfc7396Params, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*PatchTenantConfigRfc7396NoContent, error) {
	// TODO: Validate the params before sending
	if params == nil {
		params = NewPatchTenantConfigRfc7396Params()
	}
	op := &runtime.ClientOperation{
		ID:                 "patchTenantConfigRfc7396",
		Method:             "PATCH",
		PathPattern:        "/{tid}/promote/config-rfc7396",
		ProducesMediaTypes: []string{"application/json", "text/csv"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &PatchTenantConfigRfc7396Reader{formats: a.formats},
		AuthInfo:           authInfo,
		Context:            params.Context,
		Client:             params.HTTPClient,
	}
	...
	success, ok := result.(*PatchTenantConfigRfc7396NoContent)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for patchTenantConfigRfc7396: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
