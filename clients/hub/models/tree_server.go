...
type TreeServer struct {
	...
	CibaAuthenticationService *TreeCIBAAuthenticationService `json:"ciba_authentication_service,omitempty"`

	// claims
	Claims TreeClaims `json:"claims,omitempty"`

	// clients
	Clients TreeClients `json:"clients,omitempty"`
	...
	// custom apps
	CustomApps TreeCustomApps `json:"custom_apps,omitempty"`
	...
	// gateways
	Gateways TreeGateways `json:"gateways,omitempty"`
	...
	// idps
	Idps TreeIDPs `json:"idps,omitempty"`
	...
	// policies
	Policies TreePolicies `json:"policies,omitempty"`
	...
	ScopesWithoutService TreeScopes `json:"scopes_without_service,omitempty"`

	// script execution points
	ScriptExecutionPoints TreeScriptExecutionPoints `json:"script_execution_points,omitempty"`

	// scripts
	Scripts TreeScripts `json:"scripts,omitempty"`
	...
	// server consent
	ServerConsent *TreeServerConsent `json:"server_consent,omitempty"`

	// servers bindings
	ServersBindings TreeServersBindings `json:"servers_bindings,omitempty"`

	// services
	Services TreeServices `json:"services,omitempty"`
	...
	// theme binding
	ThemeBinding *TreeThemeBinding `json:"theme_binding,omitempty"`
	...
	// webhooks
	Webhooks TreeWebhooks `json:"webhooks,omitempty"`
}
