...
// Validate validates this tree feature
func (m *TreeFeature) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *TreeFeature) validateEnabled(formats strfmt.Registry) error {
...
func (m *TreeFeature) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
