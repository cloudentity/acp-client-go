...
// Validate validates this tree features
func (m TreeFeatures) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m TreeFeatures) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
