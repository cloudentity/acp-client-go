...
type TreeCrossTenantAPIPolicyBindings map[string]string

// Validate validates this tree cross tenant API policy bindings
func (m TreeCrossTenantAPIPolicyBindings) Validate(formats strfmt.Registry) error {
	return nil
}
