...
func (o *ListCustomerClientsReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /servers/{wid}/cdr/customer-clients] listCustomerClients", response, response.Code())
	}
}
...
func (o *ListCustomerClientsUnauthorized) Code() int {
	return 401
}
...
func (o *ListCustomerClientsForbidden) Code() int {
	return 403
}
...
func (o *ListCustomerClientsTooManyRequests) Code() int {
	return 429
}
