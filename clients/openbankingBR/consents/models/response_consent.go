...
// Validate validates this response consent
func (m *ResponseConsent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *ResponseConsent) validateData(formats strfmt.Registry) error {
...
func (m *ResponseConsent) validateLinks(formats strfmt.Registry) error {
...
func (m *ResponseConsent) validateMeta(formats strfmt.Registry) error {
...
func (m *ResponseConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
