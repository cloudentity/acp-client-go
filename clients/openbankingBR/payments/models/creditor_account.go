...
// Validate validates this creditor account
func (m *CreditorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *CreditorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *CreditorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *CreditorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *CreditorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *CreditorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
