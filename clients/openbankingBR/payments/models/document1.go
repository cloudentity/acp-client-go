...
// Validate validates this document1
func (m *Document1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Document1) validateIdentification(formats strfmt.Registry) error {
...
func (m *Document1) validateRel(formats strfmt.Registry) error {
...
func (m *Document1) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *Document1) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Document1) UnmarshalBinary(b []byte) error {
	var res Document1
