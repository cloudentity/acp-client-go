...
type Error1 struct {
	...
	//
	//  PAGAMENTO_DIVERGENTE_DO_CONSENTIMENTO: divergncia entre pagamento e consentimento.
...
func (m *Error1) validateCode(formats strfmt.Registry) error {
...
func (m *Error1) validateDetail(formats strfmt.Registry) error {
...
func (m *Error1) validateTitle(formats strfmt.Registry) error {
