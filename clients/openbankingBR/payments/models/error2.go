...
// Validate validates this error2
func (m *Error2) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *Error2) validateCode(formats strfmt.Registry) error {
...
func (m *Error2) validateDetail(formats strfmt.Registry) error {
...
func (m *Error2) validateTitle(formats strfmt.Registry) error {
...
func (m *Error2) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *Error2) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *Error2) UnmarshalBinary(b []byte) error {
	var res Error2
