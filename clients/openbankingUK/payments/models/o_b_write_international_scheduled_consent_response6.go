		...
		if m.Charges[i] != nil {
			if err := m.Charges[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("Data" + "." + "Charges" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *OBWriteInternationalScheduledConsentResponse6Data) validateCreationDateTime(formats strfmt.Registry) error {
	...
	if err := validate.Required("Data"+"."+"CreationDateTime", "body", strfmt.DateTime(m.CreationDateTime)); err != nil {
		return err
	}
	...
	if m.Debtor != nil {
		if err := m.Debtor.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("Data" + "." + "Debtor")
			}
			return err
		}
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6Data) validateExchangeRateInformation(formats strfmt.Registry) error {
	...
	if err := m.ExchangeRateInformation.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("Data" + "." + "ExchangeRateInformation")
		}
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6Data) validatePermission(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Data"+"."+"Permission", "body", m.Permission); err != nil {
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6Data) validateStatus(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Data"+"."+"Status", "body", m.Status); err != nil {
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6Data) validateStatusUpdateDateTime(formats strfmt.Registry) error {
	...
	if err := validate.Required("Data"+"."+"StatusUpdateDateTime", "body", strfmt.DateTime(m.StatusUpdateDateTime)); err != nil {
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6DataExchangeRateInformation) validateExchangeRate(formats strfmt.Registry) error {
	...
	if err := validate.Required("Data"+"."+"ExchangeRateInformation"+"."+"ExchangeRate", "body", float64(m.ExchangeRate)); err != nil {
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6DataExchangeRateInformation) validateRateType(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Data"+"."+"ExchangeRateInformation"+"."+"RateType", "body", m.RateType); err != nil {
		return err
	}
...
func (m *OBWriteInternationalScheduledConsentResponse6DataExchangeRateInformation) validateUnitCurrency(formats strfmt.Registry) error {
	...
	if err := validate.RequiredString("Data"+"."+"ExchangeRateInformation"+"."+"UnitCurrency", "body", m.UnitCurrency); err != nil {
		return err
	}
