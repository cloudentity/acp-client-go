...
// NewGetDomesticScheduledPaymentConsentsConsentIDParams creates a new GetDomesticScheduledPaymentConsentsConsentIDParams object,
...
func NewGetDomesticScheduledPaymentConsentsConsentIDParams() *GetDomesticScheduledPaymentConsentsConsentIDParams {
	return &GetDomesticScheduledPaymentConsentsConsentIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDomesticScheduledPaymentConsentsConsentIDParamsWithTimeout creates a new GetDomesticScheduledPaymentConsentsConsentIDParams object
...
// NewGetDomesticScheduledPaymentConsentsConsentIDParamsWithContext creates a new GetDomesticScheduledPaymentConsentsConsentIDParams object
...
// NewGetDomesticScheduledPaymentConsentsConsentIDParamsWithHTTPClient creates a new GetDomesticScheduledPaymentConsentsConsentIDParams object
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithDefaults() *GetDomesticScheduledPaymentConsentsConsentIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithTimeout(timeout time.Duration) *GetDomesticScheduledPaymentConsentsConsentIDParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithContext(ctx context.Context) *GetDomesticScheduledPaymentConsentsConsentIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithHTTPClient(client *http.Client) *GetDomesticScheduledPaymentConsentsConsentIDParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAuthorization adds the authorization to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithAuthorization(authorization string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithConsentID(consentID string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
	o.SetConsentID(consentID)
	return o
}

// SetConsentID adds the consentId to the get domestic scheduled payment consents consent Id params
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) SetConsentID(consentID string) {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithXCustomerUserAgent(xCustomerUserAgent *string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithXFapiAuthDate(xFapiAuthDate *string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithXFapiCustomerIPAddress(xFapiCustomerIPAddress *string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WithXFapiInteractionID(xFapiInteractionID *string) *GetDomesticScheduledPaymentConsentsConsentIDParams {
...
func (o *GetDomesticScheduledPaymentConsentsConsentIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
