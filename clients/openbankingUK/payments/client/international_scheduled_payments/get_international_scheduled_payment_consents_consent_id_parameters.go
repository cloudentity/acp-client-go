...
// NewGetInternationalScheduledPaymentConsentsConsentIDParams creates a new GetInternationalScheduledPaymentConsentsConsentIDParams object,
...
func NewGetInternationalScheduledPaymentConsentsConsentIDParams() *GetInternationalScheduledPaymentConsentsConsentIDParams {
	return &GetInternationalScheduledPaymentConsentsConsentIDParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetInternationalScheduledPaymentConsentsConsentIDParamsWithTimeout creates a new GetInternationalScheduledPaymentConsentsConsentIDParams object
...
// NewGetInternationalScheduledPaymentConsentsConsentIDParamsWithContext creates a new GetInternationalScheduledPaymentConsentsConsentIDParams object
...
// NewGetInternationalScheduledPaymentConsentsConsentIDParamsWithHTTPClient creates a new GetInternationalScheduledPaymentConsentsConsentIDParams object
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithDefaults() *GetInternationalScheduledPaymentConsentsConsentIDParams {
	o.SetDefaults()
	return o
}
...
//
// All values with no default are reset to their zero value.
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) SetDefaults() {
	// no default values defined for this parameter
}

// WithTimeout adds the timeout to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithTimeout(timeout time.Duration) *GetInternationalScheduledPaymentConsentsConsentIDParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithContext(ctx context.Context) *GetInternationalScheduledPaymentConsentsConsentIDParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithHTTPClient(client *http.Client) *GetInternationalScheduledPaymentConsentsConsentIDParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) SetHTTPClient(client *http.Client) {
	o.HTTPClient = client
}

// WithAuthorization adds the authorization to the get international scheduled payment consents consent Id params
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithAuthorization(authorization string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithConsentID(consentID string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) SetConsentID(consentID string) {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithXCustomerUserAgent(xCustomerUserAgent *string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithXFapiAuthDate(xFapiAuthDate *string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithXFapiCustomerIPAddress(xFapiCustomerIPAddress *string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WithXFapiInteractionID(xFapiInteractionID *string) *GetInternationalScheduledPaymentConsentsConsentIDParams {
...
func (o *GetInternationalScheduledPaymentConsentsConsentIDParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
