...
func (m *OBOtherCodeType11) contextValidateCode(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBOtherCodeType11) contextValidateDescription(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBOtherCodeType11) contextValidateName(ctx context.Context, formats strfmt.Registry) error {
