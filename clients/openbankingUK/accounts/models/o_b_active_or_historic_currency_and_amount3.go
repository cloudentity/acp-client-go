...
func (m *OBActiveOrHistoricCurrencyAndAmount3) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount3) contextValidateCurrency(ctx context.Context, formats strfmt.Registry) error {
