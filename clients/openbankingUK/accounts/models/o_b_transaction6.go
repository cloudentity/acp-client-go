...
func (m *OBTransaction6) validateAddressLine(formats strfmt.Registry) error {
	...
	if err := m.AddressLine.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("AddressLine")
		}
		return err
	}
	...
	if m.BookingDateTime != nil {
		if err := m.BookingDateTime.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("BookingDateTime")
			}
			return err
		}
	}
	...
	if m.CardInstrument != nil {
		if err := m.CardInstrument.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("CardInstrument")
			}
			return err
		}
	}
	...
	if m.DebtorAgent != nil {
		if err := m.DebtorAgent.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("DebtorAgent")
			}
			return err
		}
	}
	...
	if m.MerchantDetails != nil {
		if err := m.MerchantDetails.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("MerchantDetails")
			}
			return err
		}
	}
	...
	if m.ProprietaryBankTransactionCode != nil {
		if err := m.ProprietaryBankTransactionCode.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("ProprietaryBankTransactionCode")
			}
			return err
		}
	}
	...
	for i := 0; i < len(m.StatementReference); i++ {
		...
		if err := m.StatementReference[i].Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				...
				return ce.ValidateName("StatementReference" + "." + strconv.Itoa(i))
			}
			return err
		}
...
func (m *OBTransaction6) validateTransactionID(formats strfmt.Registry) error {
	...
	if err := m.TransactionID.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("TransactionId")
		}
		return err
	}
...
func (m *OBTransaction6) validateTransactionInformation(formats strfmt.Registry) error {
	...
	if err := m.TransactionInformation.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("TransactionInformation")
		}
		return err
	}
...
func (m *OBTransaction6) validateTransactionMutability(formats strfmt.Registry) error {
	...
	if err := m.TransactionMutability.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("TransactionMutability")
		}
		return err
	}
...
func (m *OBTransaction6) validateTransactionReference(formats strfmt.Registry) error {
	...
	if err := m.TransactionReference.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("TransactionReference")
		}
		return err
	}
...
func (m *OBTransaction6) validateValueDateTime(formats strfmt.Registry) error {
	...
	if err := m.ValueDateTime.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("ValueDateTime")
		}
		return err
	}
