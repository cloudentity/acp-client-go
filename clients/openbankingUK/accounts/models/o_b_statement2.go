		...
		if m.StatementAmount[i] != nil {
			if err := m.StatementAmount[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementAmount" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.StatementBenefit[i] != nil {
			if err := m.StatementBenefit[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementBenefit" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.StatementDateTime[i] != nil {
			if err := m.StatementDateTime[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementDateTime" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.StatementFee[i] != nil {
			if err := m.StatementFee[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementFee" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *OBStatement2) validateStatementID(formats strfmt.Registry) error {
	...
	if err := m.StatementID.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("StatementId")
		}
		return err
	}
		...
		if m.StatementInterest[i] != nil {
			if err := m.StatementInterest[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementInterest" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
		...
		if m.StatementRate[i] != nil {
			if err := m.StatementRate[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementRate" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *OBStatement2) validateStatementReference(formats strfmt.Registry) error {
	...
	if err := m.StatementReference.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("StatementReference")
		}
		return err
	}
		...
		if m.StatementValue[i] != nil {
			if err := m.StatementValue[i].Validate(formats); err != nil {
				if ve, ok := err.(*errors.Validation); ok {
					...
					return ce.ValidateName("StatementValue" + "." + strconv.Itoa(i))
				}
				return err
			}
		}
...
func (m *OBStatement2StatementFeeItems0) validateRateType(formats strfmt.Registry) error {
	...
	if err := m.RateType.Validate(formats); err != nil {
		if ve, ok := err.(*errors.Validation); ok {
			...
			return ce.ValidateName("RateType")
		}
		return err
	}
