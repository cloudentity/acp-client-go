...
func (m *OBActiveOrHistoricCurrencyAndAmount4) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount4) contextValidateCurrency(ctx context.Context, formats strfmt.Registry) error {
