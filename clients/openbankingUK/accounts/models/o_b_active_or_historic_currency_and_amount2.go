...
func (m *OBActiveOrHistoricCurrencyAndAmount2) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount2) contextValidateCurrency(ctx context.Context, formats strfmt.Registry) error {
