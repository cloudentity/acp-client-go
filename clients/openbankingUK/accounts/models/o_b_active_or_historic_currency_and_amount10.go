...
func (m *OBActiveOrHistoricCurrencyAndAmount10) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount10) contextValidateCurrency(ctx context.Context, formats strfmt.Registry) error {
