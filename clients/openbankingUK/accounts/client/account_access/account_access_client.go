...
// New creates a new account access API client with basic auth credentials.
...
// New creates a new account access API client with a bearer token for authentication.
// It takes the following parameters:
// - host: http host (github.com).
// - basePath: any base path for the API client ("/v1", "/v3").
// - scheme: http scheme ("http", "https").
...
func (a *Client) CreateAccountAccessConsents(params *CreateAccountAccessConsentsParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*CreateAccountAccessConsentsCreated, error) {
	...
	op := &runtime.ClientOperation{
		...
		ProducesMediaTypes: []string{"application/json; charset=utf-8", "application/json", "application/jose+jwe"},
		ConsumesMediaTypes: []string{"application/json; charset=utf-8", "application/json", "application/jose+jwe"},
