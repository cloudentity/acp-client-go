...
func (o *ListWorkspacesOK) Error() string {
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesOK  %+v", 200, o.Payload)
}
...
func (o *ListWorkspacesUnauthorized) Error() string {
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListWorkspacesForbidden) Error() string {
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesForbidden  %+v", 403, o.Payload)
}
...
func (o *ListWorkspacesNotFound) Error() string {
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesNotFound  %+v", 404, o.Payload)
}
...
func (o *ListWorkspacesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /workspaces][%d] listWorkspacesTooManyRequests  %+v", 429, o.Payload)
}
