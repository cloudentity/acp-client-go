...
func (m *WorkspaceIDP) validateTransformer(formats strfmt.Registry) error {
...
func (m *WorkspaceIDP) contextValidateTransformer(ctx context.Context, formats strfmt.Registry) error {
