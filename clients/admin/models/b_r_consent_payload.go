...
func (m *BRConsentPayload) validateCreatedAt(formats strfmt.Registry) error {
...
func (m *BRConsentPayload) validateSpecVersion(formats strfmt.Registry) error {
...
func (m *BRConsentPayload) validateType(formats strfmt.Registry) error {
