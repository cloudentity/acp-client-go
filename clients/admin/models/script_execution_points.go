...
func (m *ScriptExecutionPoints) validateExecutionPoints(formats strfmt.Registry) error {
...
func (m *ScriptExecutionPoints) contextValidateExecutionPoints(ctx context.Context, formats strfmt.Registry) error {
