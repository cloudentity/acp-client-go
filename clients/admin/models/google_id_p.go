...
type GoogleIDP struct {
	...
	// credentials
	Credentials *GoogleCredentials `json:"credentials,omitempty"`
	...
	// settings
	Settings *GoogleSettings `json:"settings,omitempty"`
...
func (m *GoogleIDP) validateTransformer(formats strfmt.Registry) error {
...
func (m *GoogleIDP) contextValidateTransformer(ctx context.Context, formats strfmt.Registry) error {
