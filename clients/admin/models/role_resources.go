...
type RoleResources struct {
	...
	// resources
	Resources []*RoleResource `json:"resources"`
}
...
func (m *RoleResources) validateResources(formats strfmt.Registry) error {
...
func (m *RoleResources) contextValidateResources(ctx context.Context, formats strfmt.Registry) error {
