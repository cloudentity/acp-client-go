...
func (m *TenantRoleSubject) validateRoles(formats strfmt.Registry) error {
...
var tenantRoleSubjectTypeTypePropEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		tenantRoleSubjectTypeTypePropEnum = append(tenantRoleSubjectTypeTypePropEnum, v)
	}
}
...
// prop value enum
func (m *TenantRoleSubject) validateTypeEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, tenantRoleSubjectTypeTypePropEnum, true); err != nil {
		return err
	}
	return nil
}

func (m *TenantRoleSubject) validateType(formats strfmt.Registry) error {
...
func (m *TenantRoleSubject) contextValidateRoles(ctx context.Context, formats strfmt.Registry) error {
