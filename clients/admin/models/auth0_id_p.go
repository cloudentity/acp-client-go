...
type Auth0IDP struct {
	...
	// credentials
	Credentials *Auth0Credentials `json:"credentials,omitempty"`
	...
	// settings
	Settings *Auth0Settings `json:"settings,omitempty"`
...
func (m *Auth0IDP) validateTransformer(formats strfmt.Registry) error {
...
func (m *Auth0IDP) contextValidateTransformer(ctx context.Context, formats strfmt.Registry) error {
