...
type OpenbankingBrasilPaymentV3Details struct {
	...
	// creditor account
	// Required: true
	CreditorAccount *OpenbankingBrasilPaymentV3CreditorAccount `json:"creditorAccount"`

	// local instrument
	// Required: true
	LocalInstrument *OpenbankingBrasilPaymentV3EnumLocalInstrument `json:"localInstrument"`
