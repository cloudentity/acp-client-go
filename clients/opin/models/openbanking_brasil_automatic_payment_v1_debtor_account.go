...
// OpenbankingBrasilAutomaticPaymentV1DebtorAccount OpenbankingBrasilAutomaticPaymentV1DebtorAccount DebtorAccount
//
...
//
// swagger:model OpenbankingBrasilAutomaticPaymentV1DebtorAccount
type OpenbankingBrasilAutomaticPaymentV1DebtorAccount struct {
...
// Validate validates this openbanking brasil automatic payment v1 debtor account
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) validateNumber(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil automatic payment v1 debtor account based on the context it is used
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilAutomaticPaymentV1DebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilAutomaticPaymentV1DebtorAccount
