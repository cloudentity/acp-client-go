...
func (m *OpenbankingBrasilPaymentV3Document) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3Document) validateIdentification(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Document) validateRel(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Document) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3Document
