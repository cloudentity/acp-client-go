...
func (m *OpenbankingBrasilConsentV2Links) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilConsentV2Links) validateFirst(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Links) validateLast(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Links) validateNext(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Links) validatePrev(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Links) validateSelf(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2Links) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilConsentV2Links
