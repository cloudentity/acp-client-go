...
func (m *OPINMeta) validateRequestDateTime(formats strfmt.Registry) error {
...
func (m *OPINMeta) validateTotalPages(formats strfmt.Registry) error {
...
func (m *OPINMeta) validateTotalRecords(formats strfmt.Registry) error {
