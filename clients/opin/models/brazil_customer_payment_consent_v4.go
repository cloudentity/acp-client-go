...
// BrazilCustomerPaymentConsentV4 brazil customer payment consent v4
//
// swagger:model BrazilCustomerPaymentConsentV4
type BrazilCustomerPaymentConsentV4 struct {
...
// Validate validates this brazil customer payment consent v4
func (m *BrazilCustomerPaymentConsentV4) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCustomerPaymentConsentV4) validateBusinessEntity(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateConsentID(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateCreationDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateCreditor(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateDebtorAccount(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateExpirationDateTime(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateLoggedUser(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validatePayment(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateRejectionReason(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateStatus(formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) validateStatusUpdateDateTime(formats strfmt.Registry) error {
...
// ContextValidate validate this brazil customer payment consent v4 based on the context it is used
func (m *BrazilCustomerPaymentConsentV4) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateBusinessEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateCreditor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateDebtorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateLoggedUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidatePayment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateRejectionReason(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilCustomerPaymentConsentV4) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BrazilCustomerPaymentConsentV4) UnmarshalBinary(b []byte) error {
	var res BrazilCustomerPaymentConsentV4
