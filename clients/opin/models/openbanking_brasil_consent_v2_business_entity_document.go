...
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) validateIdentification(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) validateRel(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}

// MarshalBinary interface implementation
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilConsentV2BusinessEntityDocument) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilConsentV2BusinessEntityDocument
