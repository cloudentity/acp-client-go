...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilPaymentV3ConsentsDebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3ConsentsDebtorAccount
