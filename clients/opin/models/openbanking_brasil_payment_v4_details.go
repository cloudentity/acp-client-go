...
// OpenbankingBrasilPaymentV4Details OpenbankingBrasilPaymentV4Details Details
//
// Objeto contendo os detalhes do pagamento.
//
// swagger:model OpenbankingBrasilPaymentV4Details
type OpenbankingBrasilPaymentV4Details struct {

	// creditor account
	// Required: true
	CreditorAccount *OpenbankingBrasilPaymentV4CreditorAccount `json:"creditorAccount" yaml:"creditorAccount"`

	// local instrument
	// Required: true
	LocalInstrument *OpenbankingBrasilPaymentV4EnumLocalInstrument `json:"localInstrument" yaml:"localInstrument"`
...
// Validate validates this openbanking brasil payment v4 details
func (m *OpenbankingBrasilPaymentV4Details) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV4Details) validateCreditorAccount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4Details) validateLocalInstrument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4Details) validateProxy(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4Details) validateQrCode(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil payment v4 details based on the context it is used
func (m *OpenbankingBrasilPaymentV4Details) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV4Details) contextValidateCreditorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4Details) contextValidateLocalInstrument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4Details) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilPaymentV4Details) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV4Details
