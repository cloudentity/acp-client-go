...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) validateData(formats strfmt.Registry) error {
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) validateLinks(formats strfmt.Registry) error {
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) validateMeta(formats strfmt.Registry) error {
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *BrazilCreateCustomerDataAccessConsentV2Response) UnmarshalBinary(b []byte) error {
	var res BrazilCreateCustomerDataAccessConsentV2Response
