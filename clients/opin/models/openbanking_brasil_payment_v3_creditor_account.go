...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3CreditorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3CreditorAccount
