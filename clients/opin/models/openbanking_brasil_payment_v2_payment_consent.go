...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateAmount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateCurrency(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateDate(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateDetails(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateIbgeTownCode(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateSchedule(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) validateType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) contextValidateDetails(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) contextValidateSchedule(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2PaymentConsent) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2PaymentConsent
