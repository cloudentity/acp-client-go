...
func (m *OpenbankingBrasilPaymentV3Single) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3Single) validateDate(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Single) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3Single
