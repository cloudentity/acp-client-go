...
func (m *OpenbankingBrasilPaymentV3Document1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV3Document1) validateIdentification(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Document1) validateRel(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV3Document1) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV3Document1
