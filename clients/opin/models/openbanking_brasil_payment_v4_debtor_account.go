...
// OpenbankingBrasilPaymentV4DebtorAccount OpenbankingBrasilPaymentV4DebtorAccount DebtorAccount
//
...
//
// swagger:model OpenbankingBrasilPaymentV4DebtorAccount
type OpenbankingBrasilPaymentV4DebtorAccount struct {
...
// Validate validates this openbanking brasil payment v4 debtor account
func (m *OpenbankingBrasilPaymentV4DebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) validateNumber(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil payment v4 debtor account based on the context it is used
func (m *OpenbankingBrasilPaymentV4DebtorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilPaymentV4DebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV4DebtorAccount
