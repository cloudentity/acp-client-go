...
type OpenbankingBrasilPaymentV2Data1 struct {
	...
	// business entity
	BusinessEntity *OpenbankingBrasilPaymentV2BusinessEntity `json:"businessEntity,omitempty"`
	...
	// creditor
	// Required: true
	Creditor *OpenbankingBrasilPaymentV2Identification `json:"creditor"`

	// debtor account
	DebtorAccount *OpenbankingBrasilPaymentV2DebtorAccount `json:"debtorAccount,omitempty"`
	...
	// logged user
	// Required: true
	LoggedUser *OpenbankingBrasilPaymentV2LoggedUser `json:"loggedUser"`

	// payment
	// Required: true
	Payment *OpenbankingBrasilPaymentV2PaymentConsent `json:"payment"`

	// status
	// Required: true
	Status *OpenbankingBrasilPaymentV2EnumAuthorisationStatusType `json:"status"`
...
func (m *OpenbankingBrasilPaymentV2Data1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2Data1) validateBusinessEntity(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateConsentID(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateCreationDateTime(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateCreditor(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateDebtorAccount(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateExpirationDateTime(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateLoggedUser(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validatePayment(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateStatus(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) validateStatusUpdateDateTime(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidateBusinessEntity(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidateCreditor(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidateDebtorAccount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidateLoggedUser(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidatePayment(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) contextValidateStatus(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2Data1) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2Data1
