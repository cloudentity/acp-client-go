...
func (m OpenbankingBrasilPaymentV3EnumAuthorisationStatusType) Validate(formats strfmt.Registry) error {
	return nil
}

// ContextValidate validates this openbanking brasil payment v3 enum authorisation status type based on context it is used
func (m OpenbankingBrasilPaymentV3EnumAuthorisationStatusType) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
