...
func (m *BrazilExtensionConsentRequest) validateData(formats strfmt.Registry) error {
...
func (m *BrazilExtensionConsentRequest) contextValidateData(ctx context.Context, formats strfmt.Registry) error {
...
func (m *BrazilExtensionConsentRequest) UnmarshalBinary(b []byte) error {
	var res BrazilExtensionConsentRequest
