...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentV2DebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentV2DebtorAccount
