...
func (o *SetPasswordStateBadRequest) Error() string {
	...
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateBadRequest %s", 400, payload)
}
...
func (o *SetPasswordStateUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateUnauthorized %s", 401, payload)
}
...
func (o *SetPasswordStateNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateNotFound %s", 404, payload)
}
...
func (o *SetPasswordStateUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateUnprocessableEntity %s", 422, payload)
}
