...
func (o *SetPasswordStateReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 422:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /system/pools/{ipID}/users/{userID}/password/state] setPasswordState", response, response.Code())
	}
}
...
func (o *SetPasswordStateNoContent) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateNoContent ", 204)
}
...
func (o *SetPasswordStateBadRequest) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateBadRequest  %+v", 400, o.Payload)
}
...
func (o *SetPasswordStateUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateUnauthorized  %+v", 401, o.Payload)
}
...
func (o *SetPasswordStateNotFound) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateNotFound  %+v", 404, o.Payload)
}
...
func (o *SetPasswordStateUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/users/{userID}/password/state][%d] setPasswordStateUnprocessableEntity  %+v", 422, o.Payload)
}
