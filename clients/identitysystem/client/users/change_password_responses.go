...
func (o *ChangePasswordBadRequest) Error() string {
	...
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordBadRequest %s", 400, payload)
}
...
func (o *ChangePasswordUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordUnauthorized %s", 401, payload)
}
...
func (o *ChangePasswordForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordForbidden %s", 403, payload)
}
...
func (o *ChangePasswordNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordNotFound %s", 404, payload)
}
...
func (o *ChangePasswordPreconditionFailed) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordPreconditionFailed %s", 412, payload)
}
...
func (o *ChangePasswordUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordUnprocessableEntity %s", 422, payload)
}
...
func (o *ChangePasswordTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[POST /system/pools/{ipID}/users/{userID}/change_password][%d] changePasswordTooManyRequests %s", 429, payload)
}
