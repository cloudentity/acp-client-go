...
func (o *CreateGroupCreated) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupCreated  %+v", 201, o.Payload)
}
...
func (o *CreateGroupBadRequest) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateGroupUnauthorized) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateGroupForbidden) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *CreateGroupNotFound) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *CreateGroupConflict) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupConflict  %+v", 409, o.Payload)
}
...
func (o *CreateGroupUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *CreateGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /system/pools/{ipID}/groups][%d] createGroupTooManyRequests  %+v", 429, o.Payload)
}
