...
func (o *UpdateGroupOK) Error() string {
	...
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupOK %s", 200, payload)
}
...
func (o *UpdateGroupBadRequest) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupBadRequest %s", 400, payload)
}
...
func (o *UpdateGroupUnauthorized) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupUnauthorized %s", 401, payload)
}
...
func (o *UpdateGroupForbidden) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupForbidden %s", 403, payload)
}
...
func (o *UpdateGroupNotFound) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupNotFound %s", 404, payload)
}
...
func (o *UpdateGroupConflict) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupConflict %s", 409, payload)
}
...
func (o *UpdateGroupUnprocessableEntity) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupUnprocessableEntity %s", 422, payload)
}
...
func (o *UpdateGroupTooManyRequests) Error() string {
	payload, _ := json.Marshal(o.Payload)
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupTooManyRequests %s", 429, payload)
}
