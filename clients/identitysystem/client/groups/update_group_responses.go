...
func (o *UpdateGroupReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 429:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[PUT /system/pools/{ipID}/groups/{groupID}] updateGroup", response, response.Code())
	}
}
...
func (o *UpdateGroupOK) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupOK  %+v", 200, o.Payload)
}
...
func (o *UpdateGroupBadRequest) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupBadRequest  %+v", 400, o.Payload)
}
...
func (o *UpdateGroupUnauthorized) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupUnauthorized  %+v", 401, o.Payload)
}
...
func (o *UpdateGroupForbidden) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupForbidden  %+v", 403, o.Payload)
}
...
func (o *UpdateGroupNotFound) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupNotFound  %+v", 404, o.Payload)
}
...
func (o *UpdateGroupConflict) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupConflict  %+v", 409, o.Payload)
}
...
func (o *UpdateGroupUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *UpdateGroupTooManyRequests) Error() string {
	return fmt.Sprintf("[PUT /system/pools/{ipID}/groups/{groupID}][%d] updateGroupTooManyRequests  %+v", 429, o.Payload)
}
