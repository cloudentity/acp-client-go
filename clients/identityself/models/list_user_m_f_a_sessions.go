...
func (m *ListUserMFASessions) validateSessions(formats strfmt.Registry) error {
...
func (m *ListUserMFASessions) contextValidateSessions(ctx context.Context, formats strfmt.Registry) error {
