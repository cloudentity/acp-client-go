...
func (m *ResetPasswordConfirm) validateCode(formats strfmt.Registry) error {
...
func (m *ResetPasswordConfirm) validateNewPassword(formats strfmt.Registry) error {
