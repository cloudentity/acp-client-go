...
func (m *WebAuthnCredentials) validateCredentials(formats strfmt.Registry) error {
...
func (m *WebAuthnCredentials) contextValidateCredentials(ctx context.Context, formats strfmt.Registry) error {
