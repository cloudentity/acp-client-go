...
// ContextValidate validates this login rejected based on context it is used
func (m *LoginRejected) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
