...
func (o *RotateClientSecretOK) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretOK  %+v", 200, o.Payload)
}
...
func (o *RotateClientSecretBadRequest) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretBadRequest  %+v", 400, o.Payload)
}
...
func (o *RotateClientSecretUnauthorized) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RotateClientSecretForbidden) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretForbidden  %+v", 403, o.Payload)
}
...
func (o *RotateClientSecretNotFound) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretNotFound  %+v", 404, o.Payload)
}
...
func (o *RotateClientSecretTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /client/{cid}/rotateSecret][%d] rotateClientSecretTooManyRequests  %+v", 429, o.Payload)
}
