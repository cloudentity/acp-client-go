...
// WithTid adds the tid to the list system a p is params
func (o *ListSystemAPIsParams) WithTid(tid string) *ListSystemAPIsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list system a p is params
func (o *ListSystemAPIsParams) SetTid(tid string) {
	o.Tid = tid
}
