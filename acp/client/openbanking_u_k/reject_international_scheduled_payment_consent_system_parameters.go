...
func (o *RejectInternationalScheduledPaymentConsentSystemParams) SetDefaults() {
	...
	val := RejectInternationalScheduledPaymentConsentSystemParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the reject international scheduled payment consent system params
func (o *RejectInternationalScheduledPaymentConsentSystemParams) WithTid(tid string) *RejectInternationalScheduledPaymentConsentSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the reject international scheduled payment consent system params
func (o *RejectInternationalScheduledPaymentConsentSystemParams) SetTid(tid string) {
	o.Tid = tid
}
