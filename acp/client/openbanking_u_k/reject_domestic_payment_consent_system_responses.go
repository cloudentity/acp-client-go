...
func (o *RejectDomesticPaymentConsentSystemUnauthorized) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-payment-consent/{login}/reject][%d] rejectDomesticPaymentConsentSystemUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RejectDomesticPaymentConsentSystemForbidden) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-payment-consent/{login}/reject][%d] rejectDomesticPaymentConsentSystemForbidden  %+v", 403, o.Payload)
}
...
func (o *RejectDomesticPaymentConsentSystemNotFound) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-payment-consent/{login}/reject][%d] rejectDomesticPaymentConsentSystemNotFound  %+v", 404, o.Payload)
}
...
func (o *RejectDomesticPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-payment-consent/{login}/reject][%d] rejectDomesticPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
