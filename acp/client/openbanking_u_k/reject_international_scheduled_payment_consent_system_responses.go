...
func (o *RejectInternationalScheduledPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/international-scheduled-payment-consent/{login}/reject][%d] rejectInternationalScheduledPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
