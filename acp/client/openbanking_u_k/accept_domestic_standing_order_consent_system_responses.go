...
func (o *AcceptDomesticStandingOrderConsentSystemOK) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}/accept][%d] acceptDomesticStandingOrderConsentSystemOK  %+v", 200, o.Payload)
}
...
func (o *AcceptDomesticStandingOrderConsentSystemUnauthorized) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}/accept][%d] acceptDomesticStandingOrderConsentSystemUnauthorized  %+v", 401, o.Payload)
}
...
func (o *AcceptDomesticStandingOrderConsentSystemForbidden) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}/accept][%d] acceptDomesticStandingOrderConsentSystemForbidden  %+v", 403, o.Payload)
}
...
func (o *AcceptDomesticStandingOrderConsentSystemNotFound) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}/accept][%d] acceptDomesticStandingOrderConsentSystemNotFound  %+v", 404, o.Payload)
}
...
func (o *AcceptDomesticStandingOrderConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}/accept][%d] acceptDomesticStandingOrderConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
