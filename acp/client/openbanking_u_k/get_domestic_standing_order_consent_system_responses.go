...
func (o *GetDomesticStandingOrderConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/domestic-standing-order-consent/{login}][%d] getDomesticStandingOrderConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
