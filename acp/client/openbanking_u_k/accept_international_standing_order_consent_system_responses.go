...
func (o *AcceptInternationalStandingOrderConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/international-standing-order-consent/{login}/accept][%d] acceptInternationalStandingOrderConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
