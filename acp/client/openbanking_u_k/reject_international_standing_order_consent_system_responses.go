...
func (o *RejectInternationalStandingOrderConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/international-standing-order-consent/{login}/reject][%d] rejectInternationalStandingOrderConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
