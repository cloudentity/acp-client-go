...
func (o *GetInternationalPaymentConsentSystemOK) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-payment-consent/{login}][%d] getInternationalPaymentConsentSystemOK  %+v", 200, o.Payload)
}
...
func (o *GetInternationalPaymentConsentSystemUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-payment-consent/{login}][%d] getInternationalPaymentConsentSystemUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetInternationalPaymentConsentSystemForbidden) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-payment-consent/{login}][%d] getInternationalPaymentConsentSystemForbidden  %+v", 403, o.Payload)
}
...
func (o *GetInternationalPaymentConsentSystemNotFound) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-payment-consent/{login}][%d] getInternationalPaymentConsentSystemNotFound  %+v", 404, o.Payload)
}
...
func (o *GetInternationalPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-payment-consent/{login}][%d] getInternationalPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
