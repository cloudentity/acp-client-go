...
func (o *OpenbankingAccountAccessConsentIntrospectTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/aisp/account-access-consents/introspect][%d] openbankingAccountAccessConsentIntrospectTooManyRequests  %+v", 429, o.Payload)
}
