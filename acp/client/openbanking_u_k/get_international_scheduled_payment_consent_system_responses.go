...
func (o *GetInternationalScheduledPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/system/{tid}/open-banking/international-scheduled-payment-consent/{login}][%d] getInternationalScheduledPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
