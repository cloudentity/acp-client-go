...
func (o *RejectDomesticScheduledPaymentConsentSystemTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/open-banking/domestic-scheduled-payment-consent/{login}/reject][%d] rejectDomesticScheduledPaymentConsentSystemTooManyRequests  %+v", 429, o.Payload)
}
