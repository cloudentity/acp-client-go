...
// WithAid adds the aid to the list secrets params
func (o *ListSecretsParams) WithAid(aid string) *ListSecretsParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the list secrets params
func (o *ListSecretsParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the list secrets params
func (o *ListSecretsParams) WithTid(tid string) *ListSecretsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list secrets params
func (o *ListSecretsParams) SetTid(tid string) {
	o.Tid = tid
}
