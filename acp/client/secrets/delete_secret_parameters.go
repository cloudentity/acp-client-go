...
// WithTid adds the tid to the delete secret params
func (o *DeleteSecretParams) WithTid(tid string) *DeleteSecretParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the delete secret params
func (o *DeleteSecretParams) SetTid(tid string) {
	o.Tid = tid
}
