...
func (o *GetStatsOK) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/overview][%d] getStatsOK  %+v", 200, o.Payload)
}
...
func (o *GetStatsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/overview][%d] getStatsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetStatsForbidden) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/overview][%d] getStatsForbidden  %+v", 403, o.Payload)
}
...
func (o *GetStatsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/stats/{aid}/overview][%d] getStatsTooManyRequests  %+v", 429, o.Payload)
}
