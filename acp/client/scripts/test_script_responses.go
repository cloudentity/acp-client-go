...
func (o *TestScriptOK) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptOK  %+v", 200, o.Payload)
}
...
func (o *TestScriptBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptBadRequest  %+v", 400, o.Payload)
}
...
func (o *TestScriptUnauthorized) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptUnauthorized  %+v", 401, o.Payload)
}
...
func (o *TestScriptForbidden) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptForbidden  %+v", 403, o.Payload)
}
...
func (o *TestScriptNotFound) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptNotFound  %+v", 404, o.Payload)
}
...
func (o *TestScriptConflict) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptConflict  %+v", 409, o.Payload)
}
...
func (o *TestScriptUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *TestScriptTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/admin/{tid}/servers/{aid}/scripts/test][%d] testScriptTooManyRequests  %+v", 429, o.Payload)
}
