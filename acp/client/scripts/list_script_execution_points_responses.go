...
func (o *ListScriptExecutionPointsOK) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/script-execution-points][%d] listScriptExecutionPointsOK  %+v", 200, o.Payload)
}
...
func (o *ListScriptExecutionPointsUnauthorized) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/script-execution-points][%d] listScriptExecutionPointsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListScriptExecutionPointsForbidden) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/script-execution-points][%d] listScriptExecutionPointsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListScriptExecutionPointsTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/script-execution-points][%d] listScriptExecutionPointsTooManyRequests  %+v", 429, o.Payload)
}
