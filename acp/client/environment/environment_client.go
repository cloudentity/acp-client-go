...
func (a *Client) GetDeveloperEnvironment(params *GetDeveloperEnvironmentParams, authInfo runtime.ClientAuthInfoWriter, opts ...ClientOption) (*GetDeveloperEnvironmentOK, error) {
	...
	if params == nil {
		params = NewGetDeveloperEnvironmentParams()
	}
	op := &runtime.ClientOperation{
		ID:                 "getDeveloperEnvironment",
		Method:             "GET",
		PathPattern:        "/api/developer/{tid}/{aid}/environment",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
		Reader:             &GetDeveloperEnvironmentReader{formats: a.formats},
		AuthInfo:           authInfo,
	...
	success, ok := result.(*GetDeveloperEnvironmentOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for getDeveloperEnvironment: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
