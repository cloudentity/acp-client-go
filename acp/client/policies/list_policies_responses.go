...
func (o *ListPoliciesBadRequest) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/policies][%d] listPoliciesBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListPoliciesTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /api/admin/{tid}/servers/{aid}/policies][%d] listPoliciesTooManyRequests  %+v", 429, o.Payload)
}
