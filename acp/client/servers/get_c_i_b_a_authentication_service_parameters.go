...
// WithTid adds the tid to the get c i b a authentication service params
func (o *GetCIBAAuthenticationServiceParams) WithTid(tid string) *GetCIBAAuthenticationServiceParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get c i b a authentication service params
func (o *GetCIBAAuthenticationServiceParams) SetTid(tid string) {
	o.Tid = tid
}
