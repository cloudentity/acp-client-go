...
// WithTid adds the tid to the update m f a method params
func (o *UpdateMFAMethodParams) WithTid(tid string) *UpdateMFAMethodParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the update m f a method params
func (o *UpdateMFAMethodParams) SetTid(tid string) {
	o.Tid = tid
}
