...
// WithTid adds the tid to the get external ID p params
func (o *GetExternalIDPParams) WithTid(tid string) *GetExternalIDPParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get external ID p params
func (o *GetExternalIDPParams) SetTid(tid string) {
	o.Tid = tid
}
