...
// WithTid adds the tid to the create google ID p params
func (o *CreateGoogleIDPParams) WithTid(tid string) *CreateGoogleIDPParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create google ID p params
func (o *CreateGoogleIDPParams) SetTid(tid string) {
	o.Tid = tid
}
