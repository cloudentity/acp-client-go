...
// WithAid adds the aid to the revoke rotated client secrets as developer params
func (o *RevokeRotatedClientSecretsAsDeveloperParams) WithAid(aid string) *RevokeRotatedClientSecretsAsDeveloperParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the revoke rotated client secrets as developer params
func (o *RevokeRotatedClientSecretsAsDeveloperParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the revoke rotated client secrets as developer params
func (o *RevokeRotatedClientSecretsAsDeveloperParams) WithTid(tid string) *RevokeRotatedClientSecretsAsDeveloperParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the revoke rotated client secrets as developer params
func (o *RevokeRotatedClientSecretsAsDeveloperParams) SetTid(tid string) {
	o.Tid = tid
}
