...
func (o *PatchTenantConfigurationNoContent) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationNoContent ", 204)
}
...
func (o *PatchTenantConfigurationBadRequest) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationBadRequest  %+v", 400, o.Payload)
}
...
func (o *PatchTenantConfigurationUnauthorized) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationUnauthorized  %+v", 401, o.Payload)
}
...
func (o *PatchTenantConfigurationForbidden) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationForbidden  %+v", 403, o.Payload)
}
...
func (o *PatchTenantConfigurationNotFound) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationNotFound  %+v", 404, o.Payload)
}
...
func (o *PatchTenantConfigurationUnprocessableEntity) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *PatchTenantConfigurationTooManyRequests) Error() string {
	return fmt.Sprintf("[PATCH /api/system/{tid}/configuration][%d] patchTenantConfigurationTooManyRequests  %+v", 429, o.Payload)
}
