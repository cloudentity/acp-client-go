...
func (o *RevokeOBBRConsentsOK) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsOK  %+v", 200, o.Payload)
}
...
func (o *RevokeOBBRConsentsBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsBadRequest  %+v", 400, o.Payload)
}
...
func (o *RevokeOBBRConsentsUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *RevokeOBBRConsentsForbidden) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsForbidden  %+v", 403, o.Payload)
}
...
func (o *RevokeOBBRConsentsNotFound) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsNotFound  %+v", 404, o.Payload)
}
...
func (o *RevokeOBBRConsentsTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] revokeOBBRConsentsTooManyRequests  %+v", 429, o.Payload)
}
