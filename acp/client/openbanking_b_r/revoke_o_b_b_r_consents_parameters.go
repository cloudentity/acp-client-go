...
// WithTid adds the tid to the revoke o b b r consents params
func (o *RevokeOBBRConsentsParams) WithTid(tid string) *RevokeOBBRConsentsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the revoke o b b r consents params
func (o *RevokeOBBRConsentsParams) SetTid(tid string) {
	o.Tid = tid
}
