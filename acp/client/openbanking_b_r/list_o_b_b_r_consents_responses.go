...
func (o *ListOBBRConsentsOK) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsOK  %+v", 200, o.Payload)
}
...
func (o *ListOBBRConsentsBadRequest) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsBadRequest  %+v", 400, o.Payload)
}
...
func (o *ListOBBRConsentsUnauthorized) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsUnauthorized  %+v", 401, o.Payload)
}
...
func (o *ListOBBRConsentsForbidden) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsForbidden  %+v", 403, o.Payload)
}
...
func (o *ListOBBRConsentsNotFound) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsNotFound  %+v", 404, o.Payload)
}
...
func (o *ListOBBRConsentsUnprocessableEntity) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *ListOBBRConsentsTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /api/system/{tid}/servers/{aid}/open-banking-brasil/consents][%d] listOBBRConsentsTooManyRequests  %+v", 429, o.Payload)
}
