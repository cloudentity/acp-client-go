...
func (m *InternationalPaymentConsent) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 OBWriteInternationalConsentResponse6Data
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.OBWriteInternationalConsentResponse6Data = aO0
...
func (m InternationalPaymentConsent) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.OBWriteInternationalConsentResponse6Data)
	if err != nil {
		return nil, err
	}
...
func (m *InternationalPaymentConsent) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteInternationalConsentResponse6Data
	if err := m.OBWriteInternationalConsentResponse6Data.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *InternationalPaymentConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteInternationalConsentResponse6Data
	if err := m.OBWriteInternationalConsentResponse6Data.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with OBRisk1
...
func (m *InternationalPaymentConsent) UnmarshalBinary(b []byte) error {
	var res InternationalPaymentConsent
