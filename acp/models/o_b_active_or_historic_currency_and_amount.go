...
func (m *OBActiveOrHistoricCurrencyAndAmount) validateAmount(formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount) validateCurrency(formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount) contextValidateAmount(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount) contextValidateCurrency(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OBActiveOrHistoricCurrencyAndAmount) UnmarshalBinary(b []byte) error {
	var res OBActiveOrHistoricCurrencyAndAmount
