...
func (m *Details) validateCreditorAccount(formats strfmt.Registry) error {
...
func (m *Details) validateLocalInstrument(formats strfmt.Registry) error {
...
func (m *Details) validateProxy(formats strfmt.Registry) error {
...
func (m *Details) validateQrCode(formats strfmt.Registry) error {
