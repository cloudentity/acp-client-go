...
func (m *DebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *DebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *DebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *DebtorAccount) validateNumber(formats strfmt.Registry) error {
