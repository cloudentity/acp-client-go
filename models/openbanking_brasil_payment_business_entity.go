...
type OpenbankingBrasilPaymentBusinessEntity struct {
	...
	// document
	// Required: true
	Document *OpenbankingBrasilPaymentDocument `json:"document"`
}

// Validate validates this openbanking brasil payment business entity
func (m *OpenbankingBrasilPaymentBusinessEntity) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentBusinessEntity) validateDocument(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentBusinessEntity) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentBusinessEntity) contextValidateDocument(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentBusinessEntity) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentBusinessEntity
