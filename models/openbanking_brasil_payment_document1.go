...
func (m *OpenbankingBrasilPaymentDocument1) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentDocument1) validateIdentification(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDocument1) validateRel(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDocument1) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentDocument1
