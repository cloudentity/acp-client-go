...
type ExternalIDP struct {
	...
	// credentials
	Credentials *ExternalCredentials `json:"credentials,omitempty"`
	...
	// settings
	Settings *ExternalSettings `json:"settings,omitempty"`
...
func (m *ExternalIDP) validateTransformer(formats strfmt.Registry) error {
...
func (m *ExternalIDP) contextValidateTransformer(ctx context.Context, formats strfmt.Registry) error {
