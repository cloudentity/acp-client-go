...
func (m *OpenbankingBrasilPaymentDebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilPaymentDebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDebtorAccount) validateNumber(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDebtorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilPaymentDebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilPaymentDebtorAccount
