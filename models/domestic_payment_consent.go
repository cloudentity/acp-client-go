...
func (m *DomesticPaymentConsent) UnmarshalJSON(raw []byte) error {
	// AO0
	var aO0 OBWriteDomesticConsentResponse5Data
	if err := swag.ReadJSON(raw, &aO0); err != nil {
		return err
	}
	m.OBWriteDomesticConsentResponse5Data = aO0
...
func (m DomesticPaymentConsent) MarshalJSON() ([]byte, error) {
	...
	aO0, err := swag.WriteJSON(m.OBWriteDomesticConsentResponse5Data)
	if err != nil {
		return nil, err
	}
...
func (m *DomesticPaymentConsent) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteDomesticConsentResponse5Data
	if err := m.OBWriteDomesticConsentResponse5Data.Validate(formats); err != nil {
		res = append(res, err)
	}
...
func (m *DomesticPaymentConsent) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	// validation for a type composition with OBWriteDomesticConsentResponse5Data
	if err := m.OBWriteDomesticConsentResponse5Data.ContextValidate(ctx, formats); err != nil {
		res = append(res, err)
	}
	// validation for a type composition with OBRisk1
