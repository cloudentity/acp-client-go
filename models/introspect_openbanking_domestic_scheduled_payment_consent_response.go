...
func (m *IntrospectOpenbankingDomesticScheduledPaymentConsentResponse) UnmarshalJSON(raw []byte) error {
	// AO0
	...
	// AO1
	var aO1 DomesticScheduledPaymentConsent
	if err := swag.ReadJSON(raw, &aO1); err != nil {
		return err
	}
	m.DomesticScheduledPaymentConsent = aO1
...
func (m IntrospectOpenbankingDomesticScheduledPaymentConsentResponse) MarshalJSON() ([]byte, error) {
	...
	aO1, err := swag.WriteJSON(m.DomesticScheduledPaymentConsent)
	if err != nil {
		return nil, err
	}
...
func (m *IntrospectOpenbankingDomesticScheduledPaymentConsentResponse) Validate(formats strfmt.Registry) error {
	...
	// validation for a type composition with DomesticScheduledPaymentConsent
