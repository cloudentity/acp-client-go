...
func (m *SystemServicesResponse) validateServices(formats strfmt.Registry) error {
...
func (m *SystemServicesResponse) contextValidateServices(ctx context.Context, formats strfmt.Registry) error {
...
func (m *SystemServicesResponse) UnmarshalBinary(b []byte) error {
	var res SystemServicesResponse
