...
type DomesticScheduledPaymentConsentResponse struct {
	...
	// data
	Data *DomesticScheduledPaymentConsentResponseData `json:"Data,omitempty"`
...
func (m *DomesticScheduledPaymentConsentResponse) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *DomesticScheduledPaymentConsentResponse) validateData(formats strfmt.Registry) error {
...
func (m *DomesticScheduledPaymentConsentResponse) validateLinks(formats strfmt.Registry) error {
...
func (m *DomesticScheduledPaymentConsentResponse) validateMeta(formats strfmt.Registry) error {
...
func (m *DomesticScheduledPaymentConsentResponse) validateRisk(formats strfmt.Registry) error {
...
func (m *DomesticScheduledPaymentConsentResponse) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *DomesticScheduledPaymentConsentResponse) UnmarshalBinary(b []byte) error {
	var res DomesticScheduledPaymentConsentResponse
