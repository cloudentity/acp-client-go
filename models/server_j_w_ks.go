...
type ServerJWKs struct {
	...
	// swagger keys
	// Example: []
	SwaggerKeys []*ServerJWK `json:"keys"`
...
func (m *ServerJWKs) validateSwaggerKeys(formats strfmt.Registry) error {
...
func (m *ServerJWKs) contextValidateSwaggerKeys(ctx context.Context, formats strfmt.Registry) error {
