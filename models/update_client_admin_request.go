...
var updateClientAdminRequestResponseTypesItemsEnum []interface{}
...
func init() {
	...
	for _, v := range res {
		updateClientAdminRequestResponseTypesItemsEnum = append(updateClientAdminRequestResponseTypesItemsEnum, v)
	}
}

func (m *UpdateClientAdminRequest) validateResponseTypesItemsEnum(path, location string, value string) error {
	if err := validate.EnumCase(path, location, value, updateClientAdminRequestResponseTypesItemsEnum, true); err != nil {
		return err
	}
	return nil
}
...
const (
	...
	// UpdateClientAdminRequestTokenEndpointAuthSigningAlgNone captures enum value "none"
	UpdateClientAdminRequestTokenEndpointAuthSigningAlgNone string = "none"
	...
	// UpdateClientAdminRequestTokenEndpointAuthSigningAlgH256 captures enum value "H256"
	UpdateClientAdminRequestTokenEndpointAuthSigningAlgH256 string = "H256"
)
