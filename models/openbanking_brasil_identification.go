...
// OpenbankingBrasilIdentification OpenbankingBrasilIdentification Identification
//
// Objeto contendo os dados do recebedor (creditor).
//
// swagger:model OpenbankingBrasilIdentification
type OpenbankingBrasilIdentification struct {
	...
	// person type
	// Required: true
	PersonType *OpenbankingBrasilPersonType `json:"personType"`
}

// Validate validates this openbanking brasil identification
func (m *OpenbankingBrasilIdentification) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilIdentification) validateCpfCnpj(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilIdentification) validateName(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilIdentification) validatePersonType(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil identification based on the context it is used
func (m *OpenbankingBrasilIdentification) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilIdentification) contextValidatePersonType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilIdentification) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilIdentification) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilIdentification
