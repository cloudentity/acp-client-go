...
// OpenbankingBrasilDebtorAccount OpenbankingBrasilDebtorAccount DebtorAccount
//
...
//
// swagger:model OpenbankingBrasilDebtorAccount
type OpenbankingBrasilDebtorAccount struct {

	// account type
	// Required: true
	AccountType *OpenbankingBrasilEnumAccountPaymentsType `json:"accountType"`
...
// Validate validates this openbanking brasil debtor account
func (m *OpenbankingBrasilDebtorAccount) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilDebtorAccount) validateAccountType(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilDebtorAccount) validateIspb(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilDebtorAccount) validateIssuer(formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilDebtorAccount) validateNumber(formats strfmt.Registry) error {
...
// ContextValidate validate this openbanking brasil debtor account based on the context it is used
func (m *OpenbankingBrasilDebtorAccount) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *OpenbankingBrasilDebtorAccount) contextValidateAccountType(ctx context.Context, formats strfmt.Registry) error {
...
func (m *OpenbankingBrasilDebtorAccount) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *OpenbankingBrasilDebtorAccount) UnmarshalBinary(b []byte) error {
	var res OpenbankingBrasilDebtorAccount
