...
func (m *OBWriteInternationalStandingOrderConsentResponse7DataInitiation) validateCurrencyOfTransfer(formats strfmt.Registry) error {
	...
	if err := validate.Required("CurrencyOfTransfer", "body", m.CurrencyOfTransfer); err != nil {
		return err
	}
...
func (m *OBWriteInternationalStandingOrderConsentResponse7DataInitiation) validateFirstPaymentDateTime(formats strfmt.Registry) error {
	...
	if err := validate.Required("FirstPaymentDateTime", "body", m.FirstPaymentDateTime); err != nil {
		return err
	}
