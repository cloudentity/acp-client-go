...
type ServerJWK struct {
	...
	// Resistant Name.
	// Example: RS256
	SwaggerAlg string `json:"alg,omitempty"`

	// swagger crv
	// Example: P-256
	SwaggerCrv string `json:"crv,omitempty"`
	...
	SwaggerD string `json:"d,omitempty"`

	// swagger dp
	// Example: G4sPXkc6Ya9y8oJW9_ILj4xuppu0lzi_H7VTkS8xj5SdX3coE0oimYwxIi2emTAue0UOa5dpgFGyBJ4c8tQ2VF402XRugKDTP8akYhFo5tAA77Qe_NmtuYZc3C3m3I24G2GvR5sSDxUyAN2zq8Lfn9EUms6rY3Ob8YeiKkTiBj0
	SwaggerDp string `json:"dp,omitempty"`

	// swagger dq
	// Example: s9lAH9fggBsoFR8Oac2R_E2gw282rT2kGOAhvIllETE1efrA6huUUvMfBcMpn8lqeW6vzznYY5SSQF7pMdC_agI3nG8Ibp1BUb0JUiraRNqUfLhcQb_d9GF4Dh7e74WbRsobRonujTYN1xCaP6TO61jvWrX-L18txXw494Q_cgk
	SwaggerDq string `json:"dq,omitempty"`

	// swagger e
	// Example: AQAB
	SwaggerE string `json:"e,omitempty"`

	// swagger k
	// Example: GawgguFyGrWKav7AX4VKUg
	SwaggerK string `json:"k,omitempty"`
	...
	SwaggerKid string `json:"kid,omitempty"`
	...
	// Example: sig
	SwaggerUse string `json:"use,omitempty"`

	// swagger x
	// Example: f83OJ3D2xF1Bg8vub9tLe1gHMzV76e8Tus9uPHvRVEU
	SwaggerX string `json:"x,omitempty"`
	...
	// certificate.
	SwaggerX5c []string `json:"x5c"`

	// swagger x5t
	// Example: GawgguFyGrWKav7AX4VKUg
	SwaggerX5t string `json:"x5t,omitempty"`

	// swagger x5t s256
	// Example: GawgguFyGrWKav7AX4VKUg
	SwaggerX5tS256 string `json:"x5t#S256,omitempty"`
...
func (m *ServerJWK) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateRotatedAt(formats); err != nil {
		res = append(res, err)
	}

	if err := m.validateSwaggerKty(formats); err != nil {
		res = append(res, err)
	}
...
func (m *ServerJWK) validateRotatedAt(formats strfmt.Registry) error {
	...
	if err := validate.FormatOf("rotated_at", "body", "date-time", m.RotatedAt.String(), formats); err != nil {
		return err
	}
