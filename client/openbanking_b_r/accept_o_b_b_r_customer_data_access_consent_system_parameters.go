...
func (o *AcceptOBBRCustomerDataAccessConsentSystemParams) SetDefaults() {
	...
	val := AcceptOBBRCustomerDataAccessConsentSystemParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the accept o b b r customer data access consent system params
func (o *AcceptOBBRCustomerDataAccessConsentSystemParams) WithTid(tid string) *AcceptOBBRCustomerDataAccessConsentSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the accept o b b r customer data access consent system params
func (o *AcceptOBBRCustomerDataAccessConsentSystemParams) SetTid(tid string) {
	o.Tid = tid
}
