...
func (o *DeleteDataAccessConsentNoContent) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentNoContent  %+v", 204, o.Payload)
}
...
func (o *DeleteDataAccessConsentBadRequest) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentBadRequest  %+v", 400, o.Payload)
}
...
func (o *DeleteDataAccessConsentUnauthorized) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *DeleteDataAccessConsentForbidden) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentForbidden  %+v", 403, o.Payload)
}
...
func (o *DeleteDataAccessConsentMethodNotAllowed) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentMethodNotAllowed  %+v", 405, o.Payload)
}
...
func (o *DeleteDataAccessConsentNotAcceptable) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentNotAcceptable  %+v", 406, o.Payload)
}
...
func (o *DeleteDataAccessConsentUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *DeleteDataAccessConsentUnprocessableEntity) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *DeleteDataAccessConsentTooManyRequests) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *DeleteDataAccessConsentInternalServerError) Error() string {
	return fmt.Sprintf("[DELETE /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] deleteDataAccessConsentInternalServerError  %+v", 500, o.Payload)
}
