...
func (o *RejectOBBRCustomerPaymentConsentSystemParams) SetDefaults() {
	...
	val := RejectOBBRCustomerPaymentConsentSystemParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the reject o b b r customer payment consent system params
func (o *RejectOBBRCustomerPaymentConsentSystemParams) WithTid(tid string) *RejectOBBRCustomerPaymentConsentSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the reject o b b r customer payment consent system params
func (o *RejectOBBRCustomerPaymentConsentSystemParams) SetTid(tid string) {
	o.Tid = tid
}
