...
// NewGetDataAccessConsentParams creates a new GetDataAccessConsentParams object,
...
func NewGetDataAccessConsentParams() *GetDataAccessConsentParams {
	return &GetDataAccessConsentParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewGetDataAccessConsentParamsWithTimeout creates a new GetDataAccessConsentParams object
...
// NewGetDataAccessConsentParamsWithContext creates a new GetDataAccessConsentParams object
...
// NewGetDataAccessConsentParamsWithHTTPClient creates a new GetDataAccessConsentParams object
...
func (o *GetDataAccessConsentParams) SetDefaults() {
	...
	val := GetDataAccessConsentParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the get data access consent params
func (o *GetDataAccessConsentParams) WithAid(aid string) *GetDataAccessConsentParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the get data access consent params
func (o *GetDataAccessConsentParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the get data access consent params
func (o *GetDataAccessConsentParams) WithTid(tid string) *GetDataAccessConsentParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get data access consent params
func (o *GetDataAccessConsentParams) SetTid(tid string) {
	o.Tid = tid
}
