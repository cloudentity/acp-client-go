...
// WithTid adds the tid to the rotate client secret params
func (o *RotateClientSecretParams) WithTid(tid string) *RotateClientSecretParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the rotate client secret params
func (o *RotateClientSecretParams) SetTid(tid string) {
	o.Tid = tid
}
