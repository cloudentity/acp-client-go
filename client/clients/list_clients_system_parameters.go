...
// WithTid adds the tid to the list clients system params
func (o *ListClientsSystemParams) WithTid(tid string) *ListClientsSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list clients system params
func (o *ListClientsSystemParams) SetTid(tid string) {
	o.Tid = tid
}
