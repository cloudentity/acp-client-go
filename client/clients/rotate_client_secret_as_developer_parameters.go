...
// WithAid adds the aid to the rotate client secret as developer params
func (o *RotateClientSecretAsDeveloperParams) WithAid(aid string) *RotateClientSecretAsDeveloperParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the rotate client secret as developer params
func (o *RotateClientSecretAsDeveloperParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the rotate client secret as developer params
func (o *RotateClientSecretAsDeveloperParams) WithTid(tid string) *RotateClientSecretAsDeveloperParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the rotate client secret as developer params
func (o *RotateClientSecretAsDeveloperParams) SetTid(tid string) {
	o.Tid = tid
}
