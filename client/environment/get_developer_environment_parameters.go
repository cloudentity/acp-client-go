...
func (o *GetDeveloperEnvironmentParams) SetDefaults() {
	...
	val := GetDeveloperEnvironmentParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the get developer environment params
func (o *GetDeveloperEnvironmentParams) WithAid(aid string) *GetDeveloperEnvironmentParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the get developer environment params
func (o *GetDeveloperEnvironmentParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the get developer environment params
func (o *GetDeveloperEnvironmentParams) WithTid(tid string) *GetDeveloperEnvironmentParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get developer environment params
func (o *GetDeveloperEnvironmentParams) SetTid(tid string) {
	o.Tid = tid
}
