...
for the get server consent operation typically these are written to a http.Request
*/
...
// WithTid adds the tid to the get server consent params
func (o *GetServerConsentParams) WithTid(tid string) *GetServerConsentParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get server consent params
func (o *GetServerConsentParams) SetTid(tid string) {
	o.Tid = tid
}
