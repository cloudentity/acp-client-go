...
for the list user consents by action operation typically these are written to a http.Request
*/
...
// WithAid adds the aid to the list user consents by action params
func (o *ListUserConsentsByActionParams) WithAid(aid string) *ListUserConsentsByActionParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the list user consents by action params
func (o *ListUserConsentsByActionParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the list user consents by action params
func (o *ListUserConsentsByActionParams) WithTid(tid string) *ListUserConsentsByActionParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list user consents by action params
func (o *ListUserConsentsByActionParams) SetTid(tid string) {
	o.Tid = tid
}
