...
for the list consents operation typically these are written to a http.Request
*/
...
// WithTid adds the tid to the list consents params
func (o *ListConsentsParams) WithTid(tid string) *ListConsentsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list consents params
func (o *ListConsentsParams) SetTid(tid string) {
	o.Tid = tid
}
