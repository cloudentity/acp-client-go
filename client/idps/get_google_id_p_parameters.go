...
// WithTid adds the tid to the get google ID p params
func (o *GetGoogleIDPParams) WithTid(tid string) *GetGoogleIDPParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get google ID p params
func (o *GetGoogleIDPParams) SetTid(tid string) {
	o.Tid = tid
}
