...
for the get azure ID p operation typically these are written to a http.Request
*/
...
// WithAid adds the aid to the get azure ID p params
func (o *GetAzureIDPParams) WithAid(aid string) *GetAzureIDPParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the get azure ID p params
func (o *GetAzureIDPParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the get azure ID p params
func (o *GetAzureIDPParams) WithTid(tid string) *GetAzureIDPParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get azure ID p params
func (o *GetAzureIDPParams) SetTid(tid string) {
	o.Tid = tid
}
