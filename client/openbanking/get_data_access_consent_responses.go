...
func (o *GetDataAccessConsentOK) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentOK  %+v", 200, o.Payload)
}
func (o *GetDataAccessConsentOK) GetPayload() *models.OBBRCustomerDataAccessConsentResponse {
	return o.Payload
}
...
func (o *GetDataAccessConsentBadRequest) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetDataAccessConsentUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetDataAccessConsentForbidden) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentForbidden  %+v", 403, o.Payload)
}
...
func (o *GetDataAccessConsentMethodNotAllowed) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentMethodNotAllowed  %+v", 405, o.Payload)
}
...
func (o *GetDataAccessConsentNotAcceptable) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentNotAcceptable  %+v", 406, o.Payload)
}
...
func (o *GetDataAccessConsentUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetDataAccessConsentUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *GetDataAccessConsentTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetDataAccessConsentInternalServerError) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/consents/v1/consents/{consentID}][%d] getDataAccessConsentInternalServerError  %+v", 500, o.Payload)
}
