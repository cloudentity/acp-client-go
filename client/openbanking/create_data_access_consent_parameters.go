...
func (o *CreateDataAccessConsentParams) SetDefaults() {
	...
	val := CreateDataAccessConsentParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the create data access consent params
func (o *CreateDataAccessConsentParams) WithAid(aid string) *CreateDataAccessConsentParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the create data access consent params
func (o *CreateDataAccessConsentParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the create data access consent params
func (o *CreateDataAccessConsentParams) WithTid(tid string) *CreateDataAccessConsentParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create data access consent params
func (o *CreateDataAccessConsentParams) SetTid(tid string) {
	o.Tid = tid
}
