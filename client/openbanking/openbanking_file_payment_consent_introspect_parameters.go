...
func (o *OpenbankingFilePaymentConsentIntrospectParams) SetDefaults() {
	...
	val := OpenbankingFilePaymentConsentIntrospectParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the openbanking file payment consent introspect params
func (o *OpenbankingFilePaymentConsentIntrospectParams) WithAid(aid string) *OpenbankingFilePaymentConsentIntrospectParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the openbanking file payment consent introspect params
func (o *OpenbankingFilePaymentConsentIntrospectParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the openbanking file payment consent introspect params
func (o *OpenbankingFilePaymentConsentIntrospectParams) WithTid(tid string) *OpenbankingFilePaymentConsentIntrospectParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the openbanking file payment consent introspect params
func (o *OpenbankingFilePaymentConsentIntrospectParams) SetTid(tid string) {
	o.Tid = tid
}
