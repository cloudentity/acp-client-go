...
func (o *CreateFilePaymentConsentFileBadRequest) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileBadRequest  %+v", 400, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileUnauthorized) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileUnauthorized  %+v", 401, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileForbidden) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileForbidden  %+v", 403, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileMethodNotAllowed) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileMethodNotAllowed  %+v", 405, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileNotAcceptable) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileNotAcceptable  %+v", 406, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileTooManyRequests) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *CreateFilePaymentConsentFileInternalServerError) Error() string {
	return fmt.Sprintf("[POST /{tid}/{aid}/open-banking/v3.1/pisp/file-payment-consents/file][%d] createFilePaymentConsentFileInternalServerError  %+v", 500, o.Payload)
}
