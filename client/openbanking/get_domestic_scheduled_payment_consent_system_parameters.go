...
// WithLoginID adds the login to the get domestic scheduled payment consent system params
func (o *GetDomesticScheduledPaymentConsentSystemParams) WithLoginID(login string) *GetDomesticScheduledPaymentConsentSystemParams {
	o.SetLoginID(login)
	return o
}

// SetLoginID adds the login to the get domestic scheduled payment consent system params
func (o *GetDomesticScheduledPaymentConsentSystemParams) SetLoginID(login string) {
	o.LoginID = login
}
