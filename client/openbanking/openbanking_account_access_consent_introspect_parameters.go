...
// WithAid adds the aid to the openbanking account access consent introspect params
func (o *OpenbankingAccountAccessConsentIntrospectParams) WithAid(aid string) *OpenbankingAccountAccessConsentIntrospectParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the openbanking account access consent introspect params
func (o *OpenbankingAccountAccessConsentIntrospectParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the openbanking account access consent introspect params
func (o *OpenbankingAccountAccessConsentIntrospectParams) WithTid(tid string) *OpenbankingAccountAccessConsentIntrospectParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the openbanking account access consent introspect params
func (o *OpenbankingAccountAccessConsentIntrospectParams) SetTid(tid string) {
	o.Tid = tid
}
