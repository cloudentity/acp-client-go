...
func (o *GetDomesticStandingOrderConsentSystemParams) SetDefaults() {
	...
	val := GetDomesticStandingOrderConsentSystemParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the get domestic standing order consent system params
func (o *GetDomesticStandingOrderConsentSystemParams) WithTid(tid string) *GetDomesticStandingOrderConsentSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get domestic standing order consent system params
func (o *GetDomesticStandingOrderConsentSystemParams) SetTid(tid string) {
	o.Tid = tid
}
