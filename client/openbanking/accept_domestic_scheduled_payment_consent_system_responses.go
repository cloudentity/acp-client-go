...
DomesticScheduledPaymentConsentAccepted
*/
type AcceptDomesticScheduledPaymentConsentSystemOK struct {
	Payload *models.DomesticScheduledPaymentConsentAccepted
}
...
func (o *AcceptDomesticScheduledPaymentConsentSystemOK) GetPayload() *models.DomesticScheduledPaymentConsentAccepted {
	return o.Payload
}
...
func (o *AcceptDomesticScheduledPaymentConsentSystemOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.DomesticScheduledPaymentConsentAccepted)
