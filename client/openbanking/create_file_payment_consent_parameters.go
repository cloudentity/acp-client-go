...
// NewCreateFilePaymentConsentParams creates a new CreateFilePaymentConsentParams object,
...
func NewCreateFilePaymentConsentParams() *CreateFilePaymentConsentParams {
	return &CreateFilePaymentConsentParams{
		timeout: cr.DefaultTimeout,
	}
}

// NewCreateFilePaymentConsentParamsWithTimeout creates a new CreateFilePaymentConsentParams object
...
// NewCreateFilePaymentConsentParamsWithContext creates a new CreateFilePaymentConsentParams object
...
// NewCreateFilePaymentConsentParamsWithHTTPClient creates a new CreateFilePaymentConsentParams object
...
func (o *CreateFilePaymentConsentParams) SetDefaults() {
	...
	val := CreateFilePaymentConsentParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the create file payment consent params
func (o *CreateFilePaymentConsentParams) WithAid(aid string) *CreateFilePaymentConsentParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the create file payment consent params
func (o *CreateFilePaymentConsentParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the create file payment consent params
func (o *CreateFilePaymentConsentParams) WithTid(tid string) *CreateFilePaymentConsentParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create file payment consent params
func (o *CreateFilePaymentConsentParams) SetTid(tid string) {
	o.Tid = tid
}
