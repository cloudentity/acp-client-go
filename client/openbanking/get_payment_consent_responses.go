...
func (o *GetPaymentConsentOK) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentOK  %+v", 200, o.Payload)
}
func (o *GetPaymentConsentOK) GetPayload() *models.OBBRCustomerPaymentConsentResponse {
	return o.Payload
}
...
func (o *GetPaymentConsentBadRequest) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentBadRequest  %+v", 400, o.Payload)
}
...
func (o *GetPaymentConsentUnauthorized) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentUnauthorized  %+v", 401, o.Payload)
}
...
func (o *GetPaymentConsentForbidden) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentForbidden  %+v", 403, o.Payload)
}
...
func (o *GetPaymentConsentMethodNotAllowed) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentMethodNotAllowed  %+v", 405, o.Payload)
}
...
func (o *GetPaymentConsentNotAcceptable) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentNotAcceptable  %+v", 406, o.Payload)
}
...
func (o *GetPaymentConsentUnsupportedMediaType) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentUnsupportedMediaType  %+v", 415, o.Payload)
}
...
func (o *GetPaymentConsentUnprocessableEntity) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentUnprocessableEntity  %+v", 422, o.Payload)
}
...
func (o *GetPaymentConsentTooManyRequests) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentTooManyRequests  %+v", 429, o.Payload)
}
...
func (o *GetPaymentConsentInternalServerError) Error() string {
	return fmt.Sprintf("[GET /{tid}/{aid}/open-banking-brasil/open-banking/payments/v1/consents/{consentID}][%d] getPaymentConsentInternalServerError  %+v", 500, o.Payload)
}
