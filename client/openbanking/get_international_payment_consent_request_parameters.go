...
func (o *GetInternationalPaymentConsentRequestParams) SetDefaults() {
	...
	val := GetInternationalPaymentConsentRequestParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the get international payment consent request params
func (o *GetInternationalPaymentConsentRequestParams) WithAid(aid string) *GetInternationalPaymentConsentRequestParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the get international payment consent request params
func (o *GetInternationalPaymentConsentRequestParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the get international payment consent request params
func (o *GetInternationalPaymentConsentRequestParams) WithTid(tid string) *GetInternationalPaymentConsentRequestParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get international payment consent request params
func (o *GetInternationalPaymentConsentRequestParams) SetTid(tid string) {
	o.Tid = tid
}
