...
func (o *OpenbankingDomesticStandingOrderConsentIntrospectParams) SetDefaults() {
	...
	val := OpenbankingDomesticStandingOrderConsentIntrospectParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the openbanking domestic standing order consent introspect params
func (o *OpenbankingDomesticStandingOrderConsentIntrospectParams) WithAid(aid string) *OpenbankingDomesticStandingOrderConsentIntrospectParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the openbanking domestic standing order consent introspect params
func (o *OpenbankingDomesticStandingOrderConsentIntrospectParams) SetAid(aid string) {
	o.Aid = aid
}

// WithTid adds the tid to the openbanking domestic standing order consent introspect params
func (o *OpenbankingDomesticStandingOrderConsentIntrospectParams) WithTid(tid string) *OpenbankingDomesticStandingOrderConsentIntrospectParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the openbanking domestic standing order consent introspect params
func (o *OpenbankingDomesticStandingOrderConsentIntrospectParams) SetTid(tid string) {
	o.Tid = tid
}
