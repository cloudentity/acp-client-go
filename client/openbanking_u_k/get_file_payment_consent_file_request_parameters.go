...
func (o *GetFilePaymentConsentFileRequestParams) SetDefaults() {
	...
	val := GetFilePaymentConsentFileRequestParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the get file payment consent file request params
func (o *GetFilePaymentConsentFileRequestParams) WithAid(aid string) *GetFilePaymentConsentFileRequestParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the get file payment consent file request params
func (o *GetFilePaymentConsentFileRequestParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the get file payment consent file request params
func (o *GetFilePaymentConsentFileRequestParams) WithTid(tid string) *GetFilePaymentConsentFileRequestParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get file payment consent file request params
func (o *GetFilePaymentConsentFileRequestParams) SetTid(tid string) {
	o.Tid = tid
}
