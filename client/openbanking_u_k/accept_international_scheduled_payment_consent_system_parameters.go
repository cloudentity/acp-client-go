...
func (o *AcceptInternationalScheduledPaymentConsentSystemParams) SetDefaults() {
	...
	val := AcceptInternationalScheduledPaymentConsentSystemParams{
		Tid: tidDefault,
	}
...
// WithTid adds the tid to the accept international scheduled payment consent system params
func (o *AcceptInternationalScheduledPaymentConsentSystemParams) WithTid(tid string) *AcceptInternationalScheduledPaymentConsentSystemParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the accept international scheduled payment consent system params
func (o *AcceptInternationalScheduledPaymentConsentSystemParams) SetTid(tid string) {
	o.Tid = tid
}
