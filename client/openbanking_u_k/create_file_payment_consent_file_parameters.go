...
func (o *CreateFilePaymentConsentFileParams) SetDefaults() {
	...
	val := CreateFilePaymentConsentFileParams{
		Aid: aidDefault,
		Tid: tidDefault,
	}
...
// WithAid adds the aid to the create file payment consent file params
func (o *CreateFilePaymentConsentFileParams) WithAid(aid string) *CreateFilePaymentConsentFileParams {
	o.SetAid(aid)
	return o
}

// SetAid adds the aid to the create file payment consent file params
func (o *CreateFilePaymentConsentFileParams) SetAid(aid string) {
	o.Aid = aid
}
...
// WithTid adds the tid to the create file payment consent file params
func (o *CreateFilePaymentConsentFileParams) WithTid(tid string) *CreateFilePaymentConsentFileParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the create file payment consent file params
func (o *CreateFilePaymentConsentFileParams) SetTid(tid string) {
	o.Tid = tid
}
