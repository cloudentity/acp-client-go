...
// WithTid adds the tid to the revoke key params
func (o *RevokeKeyParams) WithTid(tid string) *RevokeKeyParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the revoke key params
func (o *RevokeKeyParams) SetTid(tid string) {
	o.Tid = tid
}
