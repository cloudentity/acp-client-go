...
// WithTid adds the tid to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) WithTid(tid string) *SetAutomaticKeyRotationParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the set automatic key rotation params
func (o *SetAutomaticKeyRotationParams) SetTid(tid string) {
	o.Tid = tid
}
