...
// WithTid adds the tid to the test m f a method params
func (o *TestMFAMethodParams) WithTid(tid string) *TestMFAMethodParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the test m f a method params
func (o *TestMFAMethodParams) SetTid(tid string) {
	o.Tid = tid
}
