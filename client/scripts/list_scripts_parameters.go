...
// WithTid adds the tid to the list scripts params
func (o *ListScriptsParams) WithTid(tid string) *ListScriptsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list scripts params
func (o *ListScriptsParams) SetTid(tid string) {
	o.Tid = tid
}
