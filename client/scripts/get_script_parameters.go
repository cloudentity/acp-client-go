...
// WithTid adds the tid to the get script params
func (o *GetScriptParams) WithTid(tid string) *GetScriptParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the get script params
func (o *GetScriptParams) SetTid(tid string) {
	o.Tid = tid
}
