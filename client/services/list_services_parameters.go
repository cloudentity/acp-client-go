...
func (o *ListServicesParams) WithTid(tid string) *ListServicesParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list services params
func (o *ListServicesParams) SetTid(tid string) {
	o.Tid = tid
}
