...
// WithTid adds the tid to the list system services params
func (o *ListSystemServicesParams) WithTid(tid string) *ListSystemServicesParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list system services params
func (o *ListSystemServicesParams) SetTid(tid string) {
	o.Tid = tid
}
