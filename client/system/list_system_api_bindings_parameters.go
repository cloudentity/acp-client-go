...
// WithTid adds the tid to the list system API bindings params
func (o *ListSystemAPIBindingsParams) WithTid(tid string) *ListSystemAPIBindingsParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the list system API bindings params
func (o *ListSystemAPIBindingsParams) SetTid(tid string) {
	o.Tid = tid
}
