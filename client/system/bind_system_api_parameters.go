...
// WithTid adds the tid to the bind system API params
func (o *BindSystemAPIParams) WithTid(tid string) *BindSystemAPIParams {
	o.SetTid(tid)
	return o
}

// SetTid adds the tid to the bind system API params
func (o *BindSystemAPIParams) SetTid(tid string) {
	o.Tid = tid
}
